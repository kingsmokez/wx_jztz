...
// ===== V68策略定义 =====
// V67最佳: v67_bs_multi (WR=78.29% AR=1.65% n=258)
//   = boll_squeeze + 涨幅0.5-3% + minScore=65 + 量比>=1.8 + MA10>0.02
// V68: 微调参数验证稳定性
var V64_STRATEGIES = {
  "v68_base": {
    ...
    chgMin: 0.5, chgMax: 3, vrMin: 1.8
  },
  "v68_chg04": {
    stopLoss: -100, trailingRules: [
      { profitPct: 3, trailingPct: 1 }, { profitPct: 5, trailingPct: 2 }, { profitPct: 8, trailingPct: 3 }
    ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0.02, requirePattern: 'boll_squeeze', minScore: 65, patternWeight: 2.0,
    chgMin: 0, chgMax: 4, vrMin: 1.8
  },
  "v68_chg13": {
    stopLoss: -100, trailingRules: [
      { profitPct: 3, trailingPct: 1 }, { profitPct: 5, trailingPct: 2 }, { profitPct: 8, trailingPct: 3 }
    ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0.02, requirePattern: 'boll_squeeze', minScore: 65, patternWeight: 2.0,
    chgMin: 1, chgMax: 3, vrMin: 1.8
  },
  "v68_vr15": {
    stopLoss: -100, trailingRules: [
      { profitPct: 3, trailingPct: 1 }, { profitPct: 5, trailingPct: 2 }, { profitPct: 8, trailingPct: 3 }
    ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0.02, requirePattern: 'boll_squeeze', minScore: 65, patternWeight: 2.0,
    chgMin: 0.5, chgMax: 3, vrMin: 1.5
  },
  "v68_vr20": {
    stopLoss: -100, trailingRules: [
      { profitPct: 3, trailingPct: 1 }, { profitPct: 5, trailingPct: 2 }, { profitPct: 8, trailingPct: 3 }
    ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0.02, requirePattern: 'boll_squeeze', minScore: 65, patternWeight: 2.0,
    chgMin: 0.5, chgMax: 3, vrMin: 2.0
  },
  "v68_sc60": {
    stopLoss: -100, trailingRules: [
      { profitPct: 3, trailingPct: 1 }, { profitPct: 5, trailingPct: 2 }, { profitPct: 8, trailingPct: 3 }
  ...
  "v68_sc70": {
    stopLoss: -100, trailingRules: [
      { profitPct: 3, trailingPct: 1 }, { profitPct: 5, trailingPct: 2 }, { profitPct: 8, trailingPct: 3 }
    ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0.02, requirePattern: 'boll_squeeze', minScore: 70, patternWeight: 2.0,
    chgMin: 0.5, chgMax: 3, vrMin: 1.8
  },
  "v68_4710": {
    stopLoss: -100, trailingRules: [
  ...
  "v68_rsi70": {
    ...
    chgMin: 0.5, chgMax: 3, vrMin: 1.8, rsiMax: 70
  },
  "v68_adx20": {
    stopLoss: -100, trailingRules: [
      { profitPct: 3, trailingPct: 1 }, { profitPct: 5, trailingPct: 2 }, { profitPct: 8, trailingPct: 3 }
  ...
  "v68_pb_bs_multi": {
    ...
    chgMin: 0.5, chgMax: 3, vrMin: 1.8, allowedPatterns: ['platform_break', 'boll_squeeze']
  },
  "v68_ma10_003": {
    stopLoss: -100, trailingRules: [
      { profitPct: 3, trailingPct: 1 }, { profitPct: 5, trailingPct: 2 }, { profitPct: 8, trailingPct: 3 }
  ...
  "v68_ma5_015": {
    stopLoss: -100, trailingRules: [
      { profitPct: 3, trailingPct: 1 }, { profitPct: 5, trailingPct: 2 }, { profitPct: 8, trailingPct: 3 }
    ], maxHoldDays: 18, ma5Min: 0.15, ma10Min: 0.02, requirePattern: 'boll_squeeze', minScore: 65, patternWeight: 2.0,
    chgMin: 0.5, chgMax: 3, vrMin: 1.8
  },
  "v68_sl7": {
...
async function runBacktest() {
  ...
  console.log('V68 Strategy Backtest: bs_multi参数微调验证')
  console.log('='.repeat(80))
  ...
  var output = []
  output.push('================================================================================')
  output.push('V68 Strategy Backtest: bs_multi参数微调验证')
  output.push('================================================================================')
  output.push('')
  ...
  // V64base基线
  var v63BaseStats = calcDynamicStats(dynamicPicks['v68_base'] || [])
  ...
  var anyPicks = dynamicPicks['v68_base'] || []
  var patternStats = {}
  ...
  fs.writeFileSync(path.join(CONFIG.outputDir, 'backtest_v68.txt'), output.join('\n'), 'utf8')
  console.log('\nResults saved to backtest/results/backtest_v68.txt')
}
