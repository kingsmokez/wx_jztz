...
function simulatePickV84(dayQuotes, klineMap, dateIdxMap, topN, marketEnv, strategy) {
  ...
  for (var i = 0; i < dayQuotes.length; i++) {
    ...
    if (strategy.confirmMACDIncr && !checkMACDHistogramIncreasingV2(klines, dateIdx)) continue
...
var V84_STRATEGIES = {
  ...
  // boll_squeeze + V84新形态竞争
  "v84_boll_or_new": Object.assign({}, BASE_EXIT, {
    patternMode: 'v84_all', atrExit: true, atrMultiplier: 1.2, maxConsecUp: 4,
    ma5Min: 0.1, ma10Min: 0.02,
    requirePattern: ['boll_squeeze', 'double_bottom', 'flag_breakout', 'big_candle', 'ma20_bounce'],
    minScore: 55, patternWeight: 2.0, bollWidthMax: 0.09,
    chgMin: 1, chgMax: 2.5, vrMin: 1.2, rsiMax: 60,
    confirmMACD: true, confirmAboveMA20: true
  }),
  // 纯双底突破
  "v84_double_bottom": Object.assign({}, BASE_EXIT, {
    patternMode: 'v84_all', atrExit: true, atrMultiplier: 1.2, maxConsecUp: 4,
    ma5Min: 0.1, ma10Min: 0.02, requirePattern: 'double_bottom',
    minScore: 55, patternWeight: 2.0, bollWidthMax: 0.09,
    chgMin: 1, chgMax: 2.5, vrMin: 1.2, rsiMax: 60,
    confirmMACD: true, confirmAboveMA20: true
  }),
  // 纯旗形突破
  "v84_flag_break": Object.assign({}, BASE_EXIT, {
    patternMode: 'v84_all', atrExit: true, atrMultiplier: 1.2, maxConsecUp: 4,
    ma5Min: 0.1, ma10Min: 0.02, requirePattern: 'flag_breakout',
    minScore: 55, patternWeight: 2.0, bollWidthMax: 0.09,
    chgMin: 1, chgMax: 2.5, vrMin: 1.2, rsiMax: 60,
    confirmMACD: true, confirmAboveMA20: true
  }),
  // 纯放量长阳
  "v84_big_candle": Object.assign({}, BASE_EXIT, {
    patternMode: 'v84_all', atrExit: true, atrMultiplier: 1.2, maxConsecUp: 4,
    ma5Min: 0.1, ma10Min: 0.02, requirePattern: 'big_candle',
    minScore: 55, patternWeight: 2.0, bollWidthMax: 0.09,
    chgMin: 1, chgMax: 2.5, vrMin: 1.2, rsiMax: 60,
    confirmMACD: true, confirmAboveMA20: true
  }),
  // 纯MA20支撑反弹
  "v84_ma20_bounce": Object.assign({}, BASE_EXIT, {
    patternMode: 'v84_all', atrExit: true, atrMultiplier: 1.2, maxConsecUp: 4,
    ma5Min: 0.1, ma10Min: 0.02, requirePattern: 'ma20_bounce',
    minScore: 55, patternWeight: 2.0, bollWidthMax: 0.09,
    chgMin: 1, chgMax: 2.5, vrMin: 1.2, rsiMax: 60,
    confirmMACD: true, confirmAboveMA20: true
  }),
  // 修复版动态ATR止盈
  "v84_dynamic_atr_v2": Object.assign({}, BASE_EXIT, {
    patternMode: 'v81', atrExit: true, atrMultiplier: 1.2, maxConsecUp: 4, dynamicATR: true,
    ma5Min: 0.1, ma10Min: 0.02, requirePattern: 'boll_squeeze',
    minScore: 55, patternWeight: 2.0, bollWidthMax: 0.09,
    chgMin: 1, chgMax: 2.5, vrMin: 1.2, rsiMax: 60,
    confirmMACD: true, confirmAboveMA20: true
  ...
  // 放宽版MACD递增确认
  "v84_macd_incr_v2": Object.assign({}, BASE_EXIT, {
    patternMode: 'v81', atrExit: true, atrMultiplier: 1.2, maxConsecUp: 4,
    ma5Min: 0.1, ma10Min: 0.02, requirePattern: 'boll_squeeze',
    minScore: 55, patternWeight: 2.0, bollWidthMax: 0.09,
    chgMin: 1, chgMax: 2.5, vrMin: 1.2, rsiMax: 60,
    confirmMACD: true, confirmAboveMA20: true, confirmMACDIncr: true
  }),
  // 量价配合评分
  "v84_vol_price": Object.assign({}, BASE_EXIT, {
    patternMode: 'v81', atrExit: true, atrMultiplier: 1.2, maxConsecUp: 4,
    ma5Min: 0.1, ma10Min: 0.02, requirePattern: 'boll_squeeze',
    minScore: 55, patternWeight: 2.0, bollWidthMax: 0.09,
    chgMin: 1, chgMax: 2.5, vrMin: 1.2, rsiMax: 60,
  ...
  // 组合: boll_or_new + 量价评分
  "v84_combo_vprice": Object.assign({}, BASE_EXIT, {
    patternMode: 'v84_all', atrExit: true, atrMultiplier: 1.2, maxConsecUp: 4,
    ma5Min: 0.1, ma10Min: 0.02,
    requirePattern: ['boll_squeeze', 'double_bottom', 'flag_breakout', 'big_candle', 'ma20_bounce'],
    minScore: 55, patternWeight: 2.0, bollWidthMax: 0.09,
  ...
  // 组合: boll_or_new + 动态ATR
  "v84_combo_datr": Object.assign({}, BASE_EXIT, {
    patternMode: 'v84_all', atrExit: true, atrMultiplier: 1.2, maxConsecUp: 4, dynamicATR: true,
    ma5Min: 0.1, ma10Min: 0.02,
    requirePattern: ['boll_squeeze', 'double_bottom', 'flag_breakout', 'big_candle', 'ma20_bounce'],
    minScore: 55, patternWeight: 2.0, bollWidthMax: 0.09,
    chgMin: 1, chgMax: 2.5, vrMin: 1.2, rsiMax: 60,
  ...
  // 组合: boll_or_new + MACD递增
  "v84_combo_macd": Object.assign({}, BASE_EXIT, {
    patternMode: 'v84_all', atrExit: true, atrMultiplier: 1.2, maxConsecUp: 4,
    ma5Min: 0.1, ma10Min: 0.02,
    requirePattern: ['boll_squeeze', 'double_bottom', 'flag_breakout', 'big_candle', 'ma20_bounce'],
    minScore: 55, patternWeight: 2.0, bollWidthMax: 0.09,
  ...
  // 降低minScore让更多股票入选
  "v84_boll_or_new_m50": Object.assign({}, BASE_EXIT, {
    patternMode: 'v84_all', atrExit: true, atrMultiplier: 1.2, maxConsecUp: 4,
    ma5Min: 0.1, ma10Min: 0.02,
    requirePattern: ['boll_squeeze', 'double_bottom', 'flag_breakout', 'big_candle', 'ma20_bounce'],
  ...
  // 组合: boll_or_new + 量价 + 动态ATR + MACD递增
  "v84_combo_all": Object.assign({}, BASE_EXIT, {
    patternMode: 'v84_all', atrExit: true, atrMultiplier: 1.2, maxConsecUp: 4, dynamicATR: true,
    ma5Min: 0.1, ma10Min: 0.02,
    requirePattern: ['boll_squeeze', 'double_bottom', 'flag_breakout', 'big_candle', 'ma20_bounce'],
    minScore: 55, patternWeight: 2.0, bollWidthMax: 0.09,
    chgMin: 1, chgMax: 2.5, vrMin: 1.2, rsiMax: 60,
    confirmMACD: true, confirmAboveMA20: true, confirmMACDIncr: true, useVolPriceScore: true
  })
}

// ===== 主函数 =====
console.log('V84 Backtest V2: 形态竞争+修复动态ATR+放宽MACD')
...
for (var si = 0; si < sampleDates.length; si++) {
  ...
  for (var s = 0; s < strategyNames.length; s++) {
    ...
    var picks = simulatePickV84(dayQuotes, klineMap, dateIdxMap, CONFIG.topN, marketEnv, strategy)
...
var output = []
output.push('V84 Backtest V2: 形态竞争+修复动态ATR+放宽MACD')
