...
function simulatePickV43b(dayQuotes, klineMap, dateIdxMap, topN, marketEnv, ma5Min, ma10Min) {
...
var EXIT_STRATEGIES = {
  // === 组1: MA5>0.05+MA10>0 (更宽松MA5) + 不同退出 ===
  "MA5_005_MA10_0_h18": { stopLoss: -100, trailingRules: [
    { profitPct: 5, trailingPct: 2 }, { profitPct: 8, trailingPct: 3 }, { profitPct: 12, trailingPct: 4 }
  ], maxHoldDays: 18, ma5Min: 0.05, ma10Min: 0 },
  "MA5_005_MA10_0_h20": { stopLoss: -100, trailingRules: [
    { profitPct: 5, trailingPct: 2 }, { profitPct: 8, trailingPct: 3 }, { profitPct: 12, trailingPct: 4 }
  ], maxHoldDays: 20, ma5Min: 0.05, ma10Min: 0 },
  "MA5_005_MA10_0_h22": { stopLoss: -100, trailingRules: [
    { profitPct: 5, trailingPct: 2 }, { profitPct: 8, trailingPct: 3 }, { profitPct: 12, trailingPct: 4 }
  ], maxHoldDays: 22, ma5Min: 0.05, ma10Min: 0 },
  "MA5_005_MA10_0_tight": { stopLoss: -100, trailingRules: [
    { profitPct: 4, trailingPct: 1.5 }, { profitPct: 7, trailingPct: 2.5 }, { profitPct: 10, trailingPct: 3 }
  ], maxHoldDays: 18, ma5Min: 0.05, ma10Min: 0 },
  "MA5_005_MA10_0_loose": { stopLoss: -100, trailingRules: [
    { profitPct: 6, trailingPct: 3 }, { profitPct: 10, trailingPct: 4 }, { profitPct: 15, trailingPct: 5 }
  ], maxHoldDays: 18, ma5Min: 0.05, ma10Min: 0 },
  // === 组2: MA5>0.1+MA10>0 (V49e基准) + 更长持有 ===
  "MA5_01_MA10_0_h18": { stopLoss: -100, trailingRules: [
    { profitPct: 5, trailingPct: 2 }, { profitPct: 8, trailingPct: 3 }, { profitPct: 12, trailingPct: 4 }
  ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0 },
  "MA5_01_MA10_0_h20": { stopLoss: -100, trailingRules: [
    { profitPct: 5, trailingPct: 2 }, { profitPct: 8, trailingPct: 3 }, { profitPct: 12, trailingPct: 4 }
  ], maxHoldDays: 20, ma5Min: 0.1, ma10Min: 0 },
  "MA5_01_MA10_0_h22": { stopLoss: -100, trailingRules: [
    { profitPct: 5, trailingPct: 2 }, { profitPct: 8, trailingPct: 3 }, { profitPct: 12, trailingPct: 4 }
  ], maxHoldDays: 22, ma5Min: 0.1, ma10Min: 0 },
  "MA5_01_MA10_0_tight": { stopLoss: -100, trailingRules: [
    { profitPct: 4, trailingPct: 1.5 }, { profitPct: 7, trailingPct: 2.5 }, { profitPct: 10, trailingPct: 3 }
  ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0 },
  "MA5_01_MA10_0_loose": { stopLoss: -100, trailingRules: [
    { profitPct: 6, trailingPct: 3 }, { profitPct: 10, trailingPct: 4 }, { profitPct: 15, trailingPct: 5 }
  ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0 },
  // === 组3: MA5>0.08+MA10>0 (中间阈值) ===
  "MA5_008_MA10_0_h18": { stopLoss: -100, trailingRules: [
    { profitPct: 5, trailingPct: 2 }, { profitPct: 8, trailingPct: 3 }, { profitPct: 12, trailingPct: 4 }
  ], maxHoldDays: 18, ma5Min: 0.08, ma10Min: 0 },
  "MA5_008_MA10_0_h20": { stopLoss: -100, trailingRules: [
    { profitPct: 5, trailingPct: 2 }, { profitPct: 8, trailingPct: 3 }, { profitPct: 12, trailingPct: 4 }
  ], maxHoldDays: 20, ma5Min: 0.08, ma10Min: 0 },
  // === 组4: MA5>0.15+MA10>0 (更严格MA5) ===
  "MA5_015_MA10_0_h18": { stopLoss: -100, trailingRules: [
    { profitPct: 5, trailingPct: 2 }, { profitPct: 8, trailingPct: 3 }, { profitPct: 12, trailingPct: 4 }
  ], maxHoldDays: 18, ma5Min: 0.15, ma10Min: 0 },
  "MA5_015_MA10_0_h20": { stopLoss: -100, trailingRules: [
    { profitPct: 5, trailingPct: 2 }, { profitPct: 8, trailingPct: 3 }, { profitPct: 12, trailingPct: 4 }
  ], maxHoldDays: 20, ma5Min: 0.15, ma10Min: 0 },
  // === 组5: MA5>0.1+MA10>0.02 ===
  "MA5_01_MA10_002_h18": { stopLoss: -100, trailingRules: [
    { profitPct: 5, trailingPct: 2 }, { profitPct: 8, trailingPct: 3 }, { profitPct: 12, trailingPct: 4 }
  ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0.02 },
  "MA5_01_MA10_002_h20": { stopLoss: -100, trailingRules: [
    { profitPct: 5, trailingPct: 2 }, { profitPct: 8, trailingPct: 3 }, { profitPct: 12, trailingPct: 4 }
  ], maxHoldDays: 20, ma5Min: 0.1, ma10Min: 0.02 },
  // === 组6: MA5>0.05+MA10>0.02 ===
  "MA5_005_MA10_002_h18": { stopLoss: -100, trailingRules: [
    { profitPct: 5, trailingPct: 2 }, { profitPct: 8, trailingPct: 3 }, { profitPct: 12, trailingPct: 4 }
  ], maxHoldDays: 18, ma5Min: 0.05, ma10Min: 0.02 },
  "MA5_005_MA10_002_h20": { stopLoss: -100, trailingRules: [
    { profitPct: 5, trailingPct: 2 }, { profitPct: 8, trailingPct: 3 }, { profitPct: 12, trailingPct: 4 }
  ], maxHoldDays: 20, ma5Min: 0.05, ma10Min: 0.02 }
}
...
async function runBacktest() {
  ...
  for (var si = 0; si < sampleDates.length; si++) {
    ...
    for (var s = 0; s < strategyNames.length; s++) {
      ...
      var sPicks = simulatePickV43b(dayQuotes, klineMap, dateIdxMap, CONFIG.topN, marketEnv, strategy.ma5Min, strategy.ma10Min)
  ...
  var output = []
  output.push('================================================================================')
  output.push('V50 Strategy Backtest: MA斜率阈值+退出策略组合优化')
  output.push('================================================================================')
  output.push('')
  ...
  fs.writeFileSync(path.join(CONFIG.outputDir, 'backtest_v50.txt'), output.join('\n'), 'utf8')
