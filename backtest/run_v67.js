...
// ===== V67策略定义 =====
// V66最佳: v66_bs_only_ma10 (WR=76.51% AR=1.16% n=413)
// V67目标: 基于boll_squeeze+MA10确认，探索更高AR
var V64_STRATEGIES = {
  "v67_base": {
  ...
  "v67_bs_ma10_003": {
    stopLoss: -100, trailingRules: [
      { profitPct: 3, trailingPct: 1 }, { profitPct: 5, trailingPct: 2 }, { profitPct: 8, trailingPct: 3 }
    ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0.03, requirePattern: 'boll_squeeze', minScore: 60, patternWeight: 2.0
  },
  "v67_bs_vr2": {
    stopLoss: -100, trailingRules: [
      { profitPct: 3, trailingPct: 1 }, { profitPct: 5, trailingPct: 2 }, { profitPct: 8, trailingPct: 3 }
  ...
  "v67_pb_bs_chg15": {
    ...
    chgMin: 1, chgMax: 5, allowedPatterns: ['platform_break', 'boll_squeeze']
  },
  "v67_bs_multi": {
    stopLoss: -100, trailingRules: [
      { profitPct: 3, trailingPct: 1 }, { profitPct: 5, trailingPct: 2 }, { profitPct: 8, trailingPct: 3 }
  ...
  "v67_pb_bs_chg26": {
    ...
    chgMin: 2, chgMax: 6, allowedPatterns: ['platform_break', 'boll_squeeze']
  },
}

async function runBacktest() {
  console.log('='.repeat(80))
  console.log('V67 Strategy Backtest: boll_squeeze聚焦+多因子精选')
  console.log('='.repeat(80))
  ...
  var output = []
  output.push('================================================================================')
  output.push('V67 Strategy Backtest: boll_squeeze聚焦+多因子精选')
  output.push('================================================================================')
  output.push('')
  ...
  // V64base基线
  var v63BaseStats = calcDynamicStats(dynamicPicks['v67_base'] || [])
  ...
  var anyPicks = dynamicPicks['v67_base'] || []
  var patternStats = {}
  ...
  fs.writeFileSync(path.join(CONFIG.outputDir, 'backtest_v67.txt'), output.join('\n'), 'utf8')
  console.log('\nResults saved to backtest/results/backtest_v67.txt')
}
