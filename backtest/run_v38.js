// run_v36.js - V38策略回测: 基于price90硬过滤继续优化
var fs = require('fs')
...
var VARIANTS = {
  ...
  "V37d_ref": { v31Weight: 0.75, v10Weight: 0.25, adaptiveMarket: true, morphBonus: true, softVolConfirm: true, volPenalty: 0.9, dynamicConsec: true, consecBear: 3, consecNeutral: 5, consecBull: 6, pricePosFilter: true, pricePosThreshold: 0.90, _minScore: 60 },
  "V38a_p88_rs": { v31Weight: 0.75, v10Weight: 0.25, adaptiveMarket: true, morphBonus: true, softVolConfirm: true, volPenalty: 0.9, dynamicConsec: true, consecBear: 3, consecNeutral: 5, consecBull: 6, pricePosFilter: true, pricePosThreshold: 0.88, rsFilter: true, rsThreshold: 0, _minScore: 60 },
  "V38b_p90_rs": { v31Weight: 0.75, v10Weight: 0.25, adaptiveMarket: true, morphBonus: true, softVolConfirm: true, volPenalty: 0.9, dynamicConsec: true, consecBear: 3, consecNeutral: 5, consecBull: 6, pricePosFilter: true, pricePosThreshold: 0.90, rsFilter: true, rsThreshold: 0, _minScore: 60 },
  "V38c_p90_rs5": { v31Weight: 0.75, v10Weight: 0.25, adaptiveMarket: true, morphBonus: true, softVolConfirm: true, volPenalty: 0.9, dynamicConsec: true, consecBear: 3, consecNeutral: 5, consecBull: 6, pricePosFilter: true, pricePosThreshold: 0.90, rsFilter: true, rsThreshold: 5, _minScore: 60 },
  "V38d_p90_vc": { v31Weight: 0.75, v10Weight: 0.25, adaptiveMarket: true, morphBonus: true, softVolConfirm: true, volPenalty: 0.9, dynamicConsec: true, consecBear: 3, consecNeutral: 5, consecBull: 6, pricePosFilter: true, pricePosThreshold: 0.90, vcFilter: true, vcRatioThreshold: 1.1, _minScore: 60 },
  "V38e_p90_mom": { v31Weight: 0.75, v10Weight: 0.25, adaptiveMarket: true, morphBonus: true, softVolConfirm: true, volPenalty: 0.9, dynamicConsec: true, consecBear: 3, consecNeutral: 5, consecBull: 6, pricePosFilter: true, pricePosThreshold: 0.90, momAlignFilter: true, _minScore: 60 },
  "V38f_p90_dynmin": { v31Weight: 0.75, v10Weight: 0.25, adaptiveMarket: true, morphBonus: true, softVolConfirm: true, volPenalty: 0.9, dynamicConsec: true, consecBear: 3, consecNeutral: 5, consecBull: 6, pricePosFilter: true, pricePosThreshold: 0.90, dynamicMinScore: true, bearMinScore: 65, bullMinScore: 55, _minScore: 60 },
  "V38g_p90_rs_dynmin": { v31Weight: 0.75, v10Weight: 0.25, adaptiveMarket: true, morphBonus: true, softVolConfirm: true, volPenalty: 0.9, dynamicConsec: true, consecBear: 3, consecNeutral: 5, consecBull: 6, pricePosFilter: true, pricePosThreshold: 0.90, rsFilter: true, rsThreshold: 0, dynamicMinScore: true, bearMinScore: 65, bullMinScore: 55, _minScore: 60 },
  "V38h_p90_v31_80": { v31Weight: 0.80, v10Weight: 0.20, adaptiveMarket: true, morphBonus: true, softVolConfirm: true, volPenalty: 0.9, dynamicConsec: true, consecBear: 3, consecNeutral: 5, consecBull: 6, pricePosFilter: true, pricePosThreshold: 0.90, _minScore: 60 },
  "V38i_p90_min55": { v31Weight: 0.75, v10Weight: 0.25, adaptiveMarket: true, morphBonus: true, softVolConfirm: true, volPenalty: 0.9, dynamicConsec: true, consecBear: 3, consecNeutral: 5, consecBull: 6, pricePosFilter: true, pricePosThreshold: 0.90, _minScore: 55 },
  "V38j_p90_min65": { v31Weight: 0.75, v10Weight: 0.25, adaptiveMarket: true, morphBonus: true, softVolConfirm: true, volPenalty: 0.9, dynamicConsec: true, consecBear: 3, consecNeutral: 5, consecBull: 6, pricePosFilter: true, pricePosThreshold: 0.90, _minScore: 65 },
  ...
  "V38l_combo": { v31Weight: 0.75, v10Weight: 0.25, adaptiveMarket: true, morphBonus: true, softVolConfirm: true, volPenalty: 0.9, dynamicConsec: true, consecBear: 3, consecNeutral: 5, consecBull: 6, pricePosFilter: true, pricePosThreshold: 0.90, rsFilter: true, rsThreshold: 0, momAlignFilter: true, dynamicMinScore: true, bearMinScore: 65, bullMinScore: 55, _minScore: 60 },
}

async function runBacktest() {
  console.log('='.repeat(60))
  console.log('V37 Strategy: V34e + Price90 Hard Filter Optimization')
  console.log('='.repeat(60))
  ...
  console.log('\n' + '='.repeat(80))
  console.log('V37 Strategy Backtest - V34e + Price90 Hard Filter Optimization')
  ...
  fs.writeFileSync(path.join(CONFIG.outputDir, 'backtest_v38.txt'), output.join('\n'), 'utf8')
  console.log('\nResults saved to backtest/results/backtest_v38.txt')
}
