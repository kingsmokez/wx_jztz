...
function simulatePickV43b(dayQuotes, klineMap, dateIdxMap, topN, marketEnv, ma5Min, ma10Min, rsiMax, adxMin, v31W, v10W, minScoreOverride, filters) {
  ...
  for (var i = 0; i < dayQuotes.length; i++) {
    ...
    // V59: gapUp软加分
    var isGapUp = false
    if (filters && filters.gapUpBonus && filters.gapUpBonus > 0) {
      if (techData.candlePatterns && techData.candlePatterns.patterns && techData.candlePatterns.patterns.indexOf('gap_up') !== -1) {
        finalScore += filters.gapUpBonus
        isGapUp = true
      }
    }
    scored.push({ code: stock.code, price: stock.price, changePct: stock.changePct, score: Math.round(finalScore), industry: stock.industry || '', isGapUp: isGapUp })
  }
...
var EXIT_STRATEGIES = {
  ...
  // gapUp软加分+5
  "gap5": { stopLoss: -100, trailingRules: [
    { profitPct: 3, trailingPct: 1.5 }, { profitPct: 6, trailingPct: 2 }, { profitPct: 10, trailingPct: 3 }
  ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0.02, gapUpBonus: 5 },
  // gapUp软加分+8
  "gap8": { stopLoss: -100, trailingRules: [
    { profitPct: 3, trailingPct: 1.5 }, { profitPct: 6, trailingPct: 2 }, { profitPct: 10, trailingPct: 3 }
  ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0.02, gapUpBonus: 8 },
  // gapUp软加分+10
  "gap10": { stopLoss: -100, trailingRules: [
    { profitPct: 3, trailingPct: 1.5 }, { profitPct: 6, trailingPct: 2 }, { profitPct: 10, trailingPct: 3 }
  ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0.02, gapUpBonus: 10 },
  // gapUp软加分+12
  "gap12": { stopLoss: -100, trailingRules: [
    { profitPct: 3, trailingPct: 1.5 }, { profitPct: 6, trailingPct: 2 }, { profitPct: 10, trailingPct: 3 }
  ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0.02, gapUpBonus: 12 },
  // gapUp软加分+15
  "gap15": { stopLoss: -100, trailingRules: [
    { profitPct: 3, trailingPct: 1.5 }, { profitPct: 6, trailingPct: 2 }, { profitPct: 10, trailingPct: 3 }
  ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0.02, gapUpBonus: 15 },
  // gapUp软加分+10+topN=15
  "gap10_top15": { stopLoss: -100, trailingRules: [
    { profitPct: 3, trailingPct: 1.5 }, { profitPct: 6, trailingPct: 2 }, { profitPct: 10, trailingPct: 3 }
  ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0.02, gapUpBonus: 10, topN: 15 },
  // gapUp软加分+10+topN=10
  "gap10_top10": { stopLoss: -100, trailingRules: [
    { profitPct: 3, trailingPct: 1.5 }, { profitPct: 6, trailingPct: 2 }, { profitPct: 10, trailingPct: 3 }
  ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0.02, gapUpBonus: 10, topN: 10 },
  // gapUp软加分+10+MA10>0(宽松)
  "gap10_m10_0": { stopLoss: -100, trailingRules: [
    { profitPct: 3, trailingPct: 1.5 }, { profitPct: 6, trailingPct: 2 }, { profitPct: 10, trailingPct: 3 }
  ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0, gapUpBonus: 10 },
  // gapUp软加分+8+topN=15
  "gap8_top15": { stopLoss: -100, trailingRules: [
    { profitPct: 3, trailingPct: 1.5 }, { profitPct: 6, trailingPct: 2 }, { profitPct: 10, trailingPct: 3 }
  ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0.02, gapUpBonus: 8, topN: 15 },
  // gapUp软加分+10+topN=5(只选最强gapUp股)
  "gap10_top5": { stopLoss: -100, trailingRules: [
    { profitPct: 3, trailingPct: 1.5 }, { profitPct: 6, trailingPct: 2 }, { profitPct: 10, trailingPct: 3 }
  ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0.02, gapUpBonus: 10, topN: 5 },
  // gapUp软加分+10+topN=8
  "gap10_top8": { stopLoss: -100, trailingRules: [
    { profitPct: 3, trailingPct: 1.5 }, { profitPct: 6, trailingPct: 2 }, { profitPct: 10, trailingPct: 3 }
  ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0.02, gapUpBonus: 10, topN: 8 },
  // gapUp软加分+15+topN=5
  "gap15_top5": { stopLoss: -100, trailingRules: [
    { profitPct: 3, trailingPct: 1.5 }, { profitPct: 6, trailingPct: 2 }, { profitPct: 10, trailingPct: 3 }
  ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0.02, gapUpBonus: 15, topN: 5 },
  // gapUp软加分+20+topN=5
  "gap20_top5": { stopLoss: -100, trailingRules: [
    { profitPct: 3, trailingPct: 1.5 }, { profitPct: 6, trailingPct: 2 }, { profitPct: 10, trailingPct: 3 }
  ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0.02, gapUpBonus: 20, topN: 5 },
  // 无加分topN=5(对照)
  "noBonus_top5": { stopLoss: -100, trailingRules: [
    { profitPct: 3, trailingPct: 1.5 }, { profitPct: 6, trailingPct: 2 }, { profitPct: 10, trailingPct: 3 }
  ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0.02, topN: 5 },
  // 无加分topN=8(对照)
  "noBonus_top8": { stopLoss: -100, trailingRules: [
    { profitPct: 3, trailingPct: 1.5 }, { profitPct: 6, trailingPct: 2 }, { profitPct: 10, trailingPct: 3 }
  ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0.02, topN: 8 }
}
...
async function runBacktest() {
  ...
  for (var si = 0; si < sampleDates.length; si++) {
    ...
    for (var s = 0; s < strategyNames.length; s++) {
      ...
      var useTopN = strategy.topN || CONFIG.topN
      var sFilters = {}
      if (strategy.requireGapUp) sFilters.requireGapUp = true
      if (strategy.requireBullAlign) sFilters.requireBullAlign = true
      if (strategy.gapUpBonus) sFilters.gapUpBonus = strategy.gapUpBonus
      var sPicks = simulatePickV43b(dayQuotes, klineMap, dateIdxMap, useTopN, marketEnv, strategy.ma5Min, strategy.ma10Min, strategy.rsiMax, strategy.adxMin, strategy.v31W, strategy.v10W, strategy.minScore, sFilters)
  ...
  output.push('')
  output.push('Strategy'.padEnd(24) + '  n   WR%   AR%  AvgD  GapUp% MaxR%  MaxDD%  Reasons')
  ...
  for (var s = 0; s < strategyNames.length; s++) {
    ...
    var gapUpPct = stats.total > 0 ? Math.round(gapUpCounts[sName] / stats.total * 10000) / 100 : 0
    var line = sName.padEnd(24) + String(stats.total).padStart(4) +
      String(stats.winRate).padStart(6) + String(stats.avgReturn).padStart(6) +
      String(stats.avgExitDay).padStart(6) + String(gapUpPct + '%').padStart(7) +
