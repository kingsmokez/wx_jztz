...
function simulatePickV43b(dayQuotes, klineMap, dateIdxMap, topN, marketEnv, ma5Min, ma10Min, rsiMax, adxMin) {
...
var EXIT_STRATEGIES = {
  // === V51: 在V50最优(MA5_01_tight WR=69.86%)基础上精调 ===
  // 组1: tight变体 - 更紧/稍松的trailing
  "tight_v1": { stopLoss: -100, trailingRules: [
    { profitPct: 3, trailingPct: 1 }, { profitPct: 6, trailingPct: 2 }, { profitPct: 10, trailingPct: 3 }
  ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0, rsiMax: 75, adxMin: 22 },
  "tight_v2": { stopLoss: -100, trailingRules: [
    { profitPct: 4, trailingPct: 1.5 }, { profitPct: 7, trailingPct: 2 }, { profitPct: 11, trailingPct: 3 }
  ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0, rsiMax: 75, adxMin: 22 },
  "tight_v3": { stopLoss: -100, trailingRules: [
    { profitPct: 4, trailingPct: 1.5 }, { profitPct: 7, trailingPct: 2.5 }, { profitPct: 10, trailingPct: 3 }
  ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0, rsiMax: 70, adxMin: 22 },
  "tight_v4": { stopLoss: -100, trailingRules: [
    { profitPct: 4, trailingPct: 1.5 }, { profitPct: 7, trailingPct: 2.5 }, { profitPct: 10, trailingPct: 3 }
  ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0, rsiMax: 70, adxMin: 25 },
  // 组2: RSI过滤 - V50tight+RSI<70/65
  "tight_rsi70": { stopLoss: -100, trailingRules: [
    { profitPct: 4, trailingPct: 1.5 }, { profitPct: 7, trailingPct: 2.5 }, { profitPct: 10, trailingPct: 3 }
  ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0, rsiMax: 70 },
  "tight_rsi65": { stopLoss: -100, trailingRules: [
    { profitPct: 4, trailingPct: 1.5 }, { profitPct: 7, trailingPct: 2.5 }, { profitPct: 10, trailingPct: 3 }
  ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0, rsiMax: 65 },
  // 组3: ADX过滤 - V50tight+ADX>25/28
  "tight_adx25": { stopLoss: -100, trailingRules: [
    { profitPct: 4, trailingPct: 1.5 }, { profitPct: 7, trailingPct: 2.5 }, { profitPct: 10, trailingPct: 3 }
  ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0, adxMin: 25 },
  "tight_adx28": { stopLoss: -100, trailingRules: [
    { profitPct: 4, trailingPct: 1.5 }, { profitPct: 7, trailingPct: 2.5 }, { profitPct: 10, trailingPct: 3 }
  ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0, adxMin: 28 },
  // 组4: RSI+ADX组合过滤
  "tight_rsi70_adx25": { stopLoss: -100, trailingRules: [
    { profitPct: 4, trailingPct: 1.5 }, { profitPct: 7, trailingPct: 2.5 }, { profitPct: 10, trailingPct: 3 }
  ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0, rsiMax: 70, adxMin: 25 },
  "tight_rsi65_adx25": { stopLoss: -100, trailingRules: [
    { profitPct: 4, trailingPct: 1.5 }, { profitPct: 7, trailingPct: 2.5 }, { profitPct: 10, trailingPct: 3 }
  ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0, rsiMax: 65, adxMin: 25 },
  // 组5: loose+RSI/ADX组合(高AR方向)
  "loose_rsi70_adx25": { stopLoss: -100, trailingRules: [
    { profitPct: 6, trailingPct: 3 }, { profitPct: 10, trailingPct: 4 }, { profitPct: 15, trailingPct: 5 }
  ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0, rsiMax: 70, adxMin: 25 },
  "loose_rsi65": { stopLoss: -100, trailingRules: [
    { profitPct: 6, trailingPct: 3 }, { profitPct: 10, trailingPct: 4 }, { profitPct: 15, trailingPct: 5 }
  ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0, rsiMax: 65 },
  // 组6: MA5>0.15+tight+RSI/ADX(更高AR方向)
  "ma5_015_tight_rsi70": { stopLoss: -100, trailingRules: [
    { profitPct: 4, trailingPct: 1.5 }, { profitPct: 7, trailingPct: 2.5 }, { profitPct: 10, trailingPct: 3 }
  ], maxHoldDays: 18, ma5Min: 0.15, ma10Min: 0, rsiMax: 70 },
  "ma5_015_tight_rsi70_adx25": { stopLoss: -100, trailingRules: [
    { profitPct: 4, trailingPct: 1.5 }, { profitPct: 7, trailingPct: 2.5 }, { profitPct: 10, trailingPct: 3 }
  ], maxHoldDays: 18, ma5Min: 0.15, ma10Min: 0, rsiMax: 70, adxMin: 25 },
  "ma5_015_h20_rsi70": { stopLoss: -100, trailingRules: [
    { profitPct: 5, trailingPct: 2 }, { profitPct: 8, trailingPct: 3 }, { profitPct: 12, trailingPct: 4 }
  ], maxHoldDays: 20, ma5Min: 0.15, ma10Min: 0, rsiMax: 70 },
  // 组7: 原始tight基准(无RSI/ADX额外过滤)用于对比
  "tight_baseline": { stopLoss: -100, trailingRules: [
    { profitPct: 4, trailingPct: 1.5 }, { profitPct: 7, trailingPct: 2.5 }, { profitPct: 10, trailingPct: 3 }
  ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0 }
}
...
async function runBacktest() {
  ...
  for (var si = 0; si < sampleDates.length; si++) {
    ...
    for (var s = 0; s < strategyNames.length; s++) {
      ...
      var sPicks = simulatePickV43b(dayQuotes, klineMap, dateIdxMap, CONFIG.topN, marketEnv, strategy.ma5Min, strategy.ma10Min, strategy.rsiMax, strategy.adxMin)
  ...
  var output = []
  output.push('================================================================================')
  output.push('V51 Strategy Backtest: RSI/ADX交互过滤+trailing精调')
  output.push('================================================================================')
  output.push('')
  ...
  fs.writeFileSync(path.join(CONFIG.outputDir, 'backtest_v51.txt'), output.join('\n'), 'utf8')
