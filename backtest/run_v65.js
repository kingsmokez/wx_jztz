...
// ===== V64策略定义 =====
var V64_STRATEGIES = {
  // === 基准: V64 any_pattern (WR=73.03% AR=0.55%) ===
  "v64_any_base": {
    stopLoss: -100, trailingRules: [
      { profitPct: 3, trailingPct: 1 }, { profitPct: 5, trailingPct: 2 }, { profitPct: 8, trailingPct: 3 }
    ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0, requirePattern: 'any', minScore: 55, patternWeight: 1.5
  },
  // V65: 仅platform_break(WR=77.33%) + MA5>0.1 + minScore=60
  "v65_pb_sc60": {
    stopLoss: -100, trailingRules: [
      { profitPct: 3, trailingPct: 1 }, { profitPct: 5, trailingPct: 2 }, { profitPct: 8, trailingPct: 3 }
    ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0, requirePattern: 'platform_break', minScore: 60, patternWeight: 2.0
  },
  // V65: 仅boll_squeeze(WR=76.83%) + MA5>0.1 + minScore=60
  "v65_bs_sc60": {
    stopLoss: -100, trailingRules: [
      { profitPct: 3, trailingPct: 1 }, { profitPct: 5, trailingPct: 2 }, { profitPct: 8, trailingPct: 3 }
    ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0, requirePattern: 'boll_squeeze', minScore: 60, patternWeight: 2.0
  },
  // V65: platform_break + boll_squeeze双形态 + MA5>0.1 + minScore=60
  "v65_pb_bs": {
    stopLoss: -100, trailingRules: [
      { profitPct: 3, trailingPct: 1 }, { profitPct: 5, trailingPct: 2 }, { profitPct: 8, trailingPct: 3 }
    ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0, requirePattern: 'any', minScore: 60, patternWeight: 2.0,
    allowedPatterns: ['platform_break', 'boll_squeeze']
  },
  // V65: pb+bs+pullback三形态 + MA5>0.1 + minScore=60
  "v65_pb_bs_pull": {
    stopLoss: -100, trailingRules: [
      { profitPct: 3, trailingPct: 1 }, { profitPct: 5, trailingPct: 2 }, { profitPct: 8, trailingPct: 3 }
    ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0, requirePattern: 'any', minScore: 60, patternWeight: 2.0,
    allowedPatterns: ['platform_break', 'boll_squeeze', 'pullback_restart']
  },
  // V65: pb+bs严格版 + MA5>0.15 + ADX>22 + minScore=65
  "v65_pb_bs_strict": {
    stopLoss: -100, trailingRules: [
      { profitPct: 3, trailingPct: 1 }, { profitPct: 5, trailingPct: 2 }, { profitPct: 8, trailingPct: 3 }
    ], maxHoldDays: 18, ma5Min: 0.15, ma10Min: 0, requirePattern: 'any', minScore: 65, patternWeight: 2.5,
    adxMin: 22, allowedPatterns: ['platform_break', 'boll_squeeze']
  },
  // V65: pb+bs + 4tier止盈(2/4/7/10%)
  "v65_pb_bs_4tier": {
    stopLoss: -100, trailingRules: [
      { profitPct: 2, trailingPct: 0.5 }, { profitPct: 4, trailingPct: 1 },
      { profitPct: 7, trailingPct: 2 }, { profitPct: 10, trailingPct: 3 }
    ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0, requirePattern: 'any', minScore: 60, patternWeight: 2.0,
    allowedPatterns: ['platform_break', 'boll_squeeze']
  },
  // V65: pb+bs + 3/6/10%阶梯(更宽松)
  "v65_pb_bs_3610": {
    stopLoss: -100, trailingRules: [
  ...
  "v65_pb_bs_21d": {
    ...
    ], maxHoldDays: 21, ma5Min: 0.1, ma10Min: 0, requirePattern: 'any', minScore: 60, patternWeight: 2.0,
    allowedPatterns: ['platform_break', 'boll_squeeze']
  },
  // V65: pb+bs + MA10>0.02(趋势确认)
  "v65_pb_bs_ma10": {
    stopLoss: -100, trailingRules: [
      { profitPct: 3, trailingPct: 1 }, { profitPct: 5, trailingPct: 2 }, { profitPct: 8, trailingPct: 3 }
    ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0.02, requirePattern: 'any', minScore: 60, patternWeight: 2.0,
    allowedPatterns: ['platform_break', 'boll_squeeze']
  },
  // V65: pb+bs + RSI<70(过滤超买)
  "v65_pb_bs_rsi70": {
    stopLoss: -100, trailingRules: [
      { profitPct: 3, trailingPct: 1 }, { profitPct: 5, trailingPct: 2 }, { profitPct: 8, trailingPct: 3 }
    ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0, requirePattern: 'any', minScore: 60, patternWeight: 2.0,
    rsiMax: 70, allowedPatterns: ['platform_break', 'boll_squeeze']
  },
  // V65: pb+bs+gapUp 三形态 + MA5>0.1 + minScore=65
  "v65_pb_bs_gap": {
    stopLoss: -100, trailingRules: [
      { profitPct: 3, trailingPct: 1 }, { profitPct: 5, trailingPct: 2 }, { profitPct: 8, trailingPct: 3 }
    ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0, requirePattern: 'any', minScore: 65, patternWeight: 2.0,
    allowedPatterns: ['platform_break', 'boll_squeeze', 'gapUp']
  },
  // V65: 1.5/3/6%阶梯(更早锁利) + pb+bs
  "v65_pb_bs_early_lock": {
    stopLoss: -100, trailingRules: [
      { profitPct: 1.5, trailingPct: 0.5 }, { profitPct: 3, trailingPct: 1 },
      { profitPct: 6, trailingPct: 2 }
    ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0, requirePattern: 'any', minScore: 60, patternWeight: 2.0,
    allowedPatterns: ['platform_break', 'boll_squeeze']
  },
  // V65: pb+bs + minScore=70(最严格)
  "v65_pb_bs_sc70": {
    stopLoss: -100, trailingRules: [
      { profitPct: 3, trailingPct: 1 }, { profitPct: 5, trailingPct: 2 }, { profitPct: 8, trailingPct: 3 }
    ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0, requirePattern: 'any', minScore: 70, patternWeight: 2.0,
    allowedPatterns: ['platform_break', 'boll_squeeze']
  },
}
...
async function runBacktest() {
  ...
  console.log('V65 Strategy Backtest: 高胜率形态聚焦(platform_break+boll_squeeze)+严格过滤')
  console.log('='.repeat(80))
  ...
  // 运行各策略
  var strategyNames = Object.keys(V64_STRATEGIES)
  var dynamicPicks = {}
  var patternCounts = {}
  ...
  for (var si = 0; si < sampleDates.length; si++) {
    ...
    for (var s = 0; s < strategyNames.length; s++) {
      ...
      var strategy = V64_STRATEGIES[sName]
  ...
  var output = []
  output.push('================================================================================')
  output.push('V65 Strategy Backtest: 高胜率形态聚焦(platform_break+boll_squeeze)+严格过滤')
  output.push('================================================================================')
  output.push('')
  ...
  summaryLines.push('')
  summaryLines.push('Strategy'.padEnd(24) + '  n   WR%   AR%  AvgD  vsV64baseWR  vsV64baseAR  PatternBreakdown')
  summaryLines.push('-'.repeat(110))

  // V64base基线
  var v63BaseStats = calcDynamicStats(dynamicPicks['v64_any_base'] || [])
  var v64BaseWR = v63BaseStats.winRate
  var v64BaseAR = v63BaseStats.avgReturn
  ...
  for (var s = 0; s < strategyNames.length; s++) {
    ...
    var wrDiff = (stats.winRate - v64BaseWR).toFixed(2)
    var arDiff = (stats.avgReturn - v64BaseAR).toFixed(2)
    ...
    if (stats.winRate > v64BaseWR && stats.avgReturn > v64BaseAR) {
      console.log('>>> ' + sName + ': WR=' + stats.winRate + '% AR=' + stats.avgReturn + '% avgDay=' + stats.avgExitDay + ' BEATS V64base!')
    }
  }
  ...
  var anyPicks = dynamicPicks['v64_any_base'] || []
  var patternStats = {}
  ...
  output.push('| V64base | gapUp+3/5/8% | ' + v64BaseWR + ' | ' + v64BaseAR + ' | ' + v63BaseStats.total + ' | ' + v63BaseStats.avgExitDay + ' |')
  
  // 找最佳V64策略
  var bestV64 = null, bestV64WR = 0, bestV64AR = 0
  for (var s = 0; s < strategyNames.length; s++) {
    var sName = strategyNames[s]
    if (sName === 'v63_gapUp') continue
    var stats = calcDynamicStats(dynamicPicks[sName])
  ...
  fs.writeFileSync(path.join(CONFIG.outputDir, 'backtest_v65.txt'), output.join('\n'), 'utf8')
  console.log('\nResults saved to backtest/results/backtest_v65.txt')
}
