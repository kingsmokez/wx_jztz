// run_v36.js - V37策略回测: V34e基础上增加硬过滤排除条件
var fs = require('fs')
...
var VARIANTS = {
  ...
  "V37a_rs_pos": { v31Weight: 0.75, v10Weight: 0.25, adaptiveMarket: true, morphBonus: true, softVolConfirm: true, volPenalty: 0.9, dynamicConsec: true, consecBear: 3, consecNeutral: 5, consecBull: 6, rsFilter: true, rsThreshold: 0, _minScore: 60 },
  "V37b_rs_5": { v31Weight: 0.75, v10Weight: 0.25, adaptiveMarket: true, morphBonus: true, softVolConfirm: true, volPenalty: 0.9, dynamicConsec: true, consecBear: 3, consecNeutral: 5, consecBull: 6, rsFilter: true, rsThreshold: 5, _minScore: 60 },
  "V37c_price85": { v31Weight: 0.75, v10Weight: 0.25, adaptiveMarket: true, morphBonus: true, softVolConfirm: true, volPenalty: 0.9, dynamicConsec: true, consecBear: 3, consecNeutral: 5, consecBull: 6, pricePosFilter: true, pricePosThreshold: 0.85, _minScore: 60 },
  "V37d_price90": { v31Weight: 0.75, v10Weight: 0.25, adaptiveMarket: true, morphBonus: true, softVolConfirm: true, volPenalty: 0.9, dynamicConsec: true, consecBear: 3, consecNeutral: 5, consecBull: 6, pricePosFilter: true, pricePosThreshold: 0.90, _minScore: 60 },
  "V37e_vc": { v31Weight: 0.75, v10Weight: 0.25, adaptiveMarket: true, morphBonus: true, softVolConfirm: true, volPenalty: 0.9, dynamicConsec: true, consecBear: 3, consecNeutral: 5, consecBull: 6, vcFilter: true, vcRatioThreshold: 1.1, _minScore: 60 },
  "V37f_voldry": { v31Weight: 0.75, v10Weight: 0.25, adaptiveMarket: true, morphBonus: true, softVolConfirm: true, volPenalty: 0.9, dynamicConsec: true, consecBear: 3, consecNeutral: 5, consecBull: 6, volDryFilter: true, _minScore: 60 },
  "V37g_momalign": { v31Weight: 0.75, v10Weight: 0.25, adaptiveMarket: true, morphBonus: true, softVolConfirm: true, volPenalty: 0.9, dynamicConsec: true, consecBear: 3, consecNeutral: 5, consecBull: 6, momAlignFilter: true, _minScore: 60 },
  "V37h_dynmin": { v31Weight: 0.75, v10Weight: 0.25, adaptiveMarket: true, morphBonus: true, softVolConfirm: true, volPenalty: 0.9, dynamicConsec: true, consecBear: 3, consecNeutral: 5, consecBull: 6, dynamicMinScore: true, bearMinScore: 65, bullMinScore: 55, _minScore: 60 },
  "V37i_combo1": { v31Weight: 0.75, v10Weight: 0.25, adaptiveMarket: true, morphBonus: true, softVolConfirm: true, volPenalty: 0.9, dynamicConsec: true, consecBear: 3, consecNeutral: 5, consecBull: 6, rsFilter: true, rsThreshold: 0, pricePosFilter: true, pricePosThreshold: 0.85, momAlignFilter: true, _minScore: 60 },
  "V37j_combo2": { v31Weight: 0.75, v10Weight: 0.25, adaptiveMarket: true, morphBonus: true, softVolConfirm: true, volPenalty: 0.9, dynamicConsec: true, consecBear: 3, consecNeutral: 5, consecBull: 6, rsFilter: true, rsThreshold: 0, pricePosFilter: true, pricePosThreshold: 0.85, momAlignFilter: true, dynamicMinScore: true, bearMinScore: 65, bullMinScore: 55, _minScore: 60 },
  "V37k_all": { v31Weight: 0.75, v10Weight: 0.25, adaptiveMarket: true, morphBonus: true, softVolConfirm: true, volPenalty: 0.9, dynamicConsec: true, consecBear: 3, consecNeutral: 5, consecBull: 6, rsFilter: true, rsThreshold: 0, pricePosFilter: true, pricePosThreshold: 0.85, vcFilter: true, vcRatioThreshold: 1.1, momAlignFilter: true, dynamicMinScore: true, bearMinScore: 65, bullMinScore: 55, _minScore: 60 },
}

async function runBacktest() {
  console.log('='.repeat(60))
  console.log('V37 Strategy: V34e + Hard Filter Exclusion')
  console.log('='.repeat(60))
  ...
  console.log('\n' + '='.repeat(80))
  console.log('V37 Strategy Backtest - V34e + Hard Filter Exclusion')
  ...
  fs.writeFileSync(path.join(CONFIG.outputDir, 'backtest_v37.txt'), output.join('\n'), 'utf8')
  console.log('\nResults saved to backtest/results/backtest_v37.txt')
}
