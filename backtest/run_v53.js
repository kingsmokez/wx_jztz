...
var EXIT_STRATEGIES = {
  // === V53: 最终策略选择 ===
  // 候选1: 4tier (WR=73.97% AR=3.15%) - 最高WR
  "4tier_base": { stopLoss: -100, trailingRules: [
  ...
  "4tier_h20": { stopLoss: -100, trailingRules: [
    { profitPct: 2, trailingPct: 0.5 }, { profitPct: 4, trailingPct: 1 }, { profitPct: 7, trailingPct: 2 }, { profitPct: 10, trailingPct: 3 }
  ], maxHoldDays: 20, ma5Min: 0.1, ma10Min: 0 },
  // 候选2: p3_t1.5 (WR=72.6% AR=3.93%) - 最佳平衡
  "p3_t1.5_base": { stopLoss: -100, trailingRules: [
    { profitPct: 3, trailingPct: 1.5 }, { profitPct: 6, trailingPct: 2 }, { profitPct: 10, trailingPct: 3 }
  ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0 },
  "p3_t1.5_h20": { stopLoss: -100, trailingRules: [
    { profitPct: 3, trailingPct: 1.5 }, { profitPct: 6, trailingPct: 2 }, { profitPct: 10, trailingPct: 3 }
  ], maxHoldDays: 20, ma5Min: 0.1, ma10Min: 0 },
  // 候选3: hybrid - 4tier前2档+p3_t1.5后1档
  "hybrid_4t_p3": { stopLoss: -100, trailingRules: [
    { profitPct: 2, trailingPct: 0.5 }, { profitPct: 4, trailingPct: 1 }, { profitPct: 10, trailingPct: 3 }
  ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0 },
  "hybrid_4t_p3_h20": { stopLoss: -100, trailingRules: [
    { profitPct: 2, trailingPct: 0.5 }, { profitPct: 4, trailingPct: 1 }, { profitPct: 10, trailingPct: 3 }
  ], maxHoldDays: 20, ma5Min: 0.1, ma10Min: 0 },
  // 候选4: 4tier+MA10>0.02 (V52 v1_ma10_002 WR=73.24%)
  "4tier_ma10_002": { stopLoss: -100, trailingRules: [
    { profitPct: 2, trailingPct: 0.5 }, { profitPct: 4, trailingPct: 1 }, { profitPct: 7, trailingPct: 2 }, { profitPct: 10, trailingPct: 3 }
  ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0.02 },
  "p3_t1.5_ma10_002": { stopLoss: -100, trailingRules: [
    { profitPct: 3, trailingPct: 1.5 }, { profitPct: 6, trailingPct: 2 }, { profitPct: 10, trailingPct: 3 }
  ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0.02 },
  // 候选5: 5档trailing(极致WR)
  "5tier": { stopLoss: -100, trailingRules: [
    { profitPct: 1.5, trailingPct: 0.3 }, { profitPct: 3, trailingPct: 0.8 }, { profitPct: 5, trailingPct: 1.5 }, { profitPct: 8, trailingPct: 2.5 }, { profitPct: 12, trailingPct: 3.5 }
  ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0 },
  "5tier_h20": { stopLoss: -100, trailingRules: [
    { profitPct: 1.5, trailingPct: 0.3 }, { profitPct: 3, trailingPct: 0.8 }, { profitPct: 5, trailingPct: 1.5 }, { profitPct: 8, trailingPct: 2.5 }, { profitPct: 12, trailingPct: 3.5 }
  ], maxHoldDays: 20, ma5Min: 0.1, ma10Min: 0 },
  // 候选6: p3_t1.5+4th档(让利润跑更远)
  "p3_t1.5_4tier": { stopLoss: -100, trailingRules: [
    { profitPct: 3, trailingPct: 1.5 }, { profitPct: 6, trailingPct: 2 }, { profitPct: 10, trailingPct: 3 }, { profitPct: 15, trailingPct: 4 }
  ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0 },
  "p3_t1.5_4tier_h20": { stopLoss: -100, trailingRules: [
    { profitPct: 3, trailingPct: 1.5 }, { profitPct: 6, trailingPct: 2 }, { profitPct: 10, trailingPct: 3 }, { profitPct: 15, trailingPct: 4 }
  ], maxHoldDays: 20, ma5Min: 0.1, ma10Min: 0 },
  // 候选7: V49e原版基准(对比用)
  "v49e_baseline": { stopLoss: -100, trailingRules: [
...
async function runBacktest() {
  ...
  var output = []
  output.push('================================================================================')
  output.push('V53 Strategy Backtest: 最终策略选择(4tier vs p3_t1.5 vs hybrid)')
  output.push('================================================================================')
  output.push('')
  ...
  fs.writeFileSync(path.join(CONFIG.outputDir, 'backtest_v53.txt'), output.join('\n'), 'utf8')
