// run_v44.js - V44策略回测: 自适应RS+新形态确认: 基于p95价格位置硬过滤深挖最优参数
var fs = require('fs')
...
var VARIANTS = {
  ...
  // V42i基准 (10dWR=60.50%, n=119) - 高胜率低收益
  ...
  // V44a: rs7+vr+m55 (V42i放松minScore)
  "V44a_rs7_vr_m55": { v31Weight: 0.75, v10Weight: 0.25, adaptiveMarket: true, morphBonus: true, softVolConfirm: true, volPenalty: 0.9, dynamicConsec: true, consecBear: 3, consecNeutral: 5, consecBull: 6, pricePosFilter: true, pricePosThreshold: 0.95, rsFilter: true, rsThreshold: 7, volumeRatioFilter: true, volumeRatioMin: 1.5, _minScore: 55 },
  // V44b: 动态RS阈值(牛8/中6/熊4)+vr+m55
  "V44b_dynrs_vr_m55": { v31Weight: 0.75, v10Weight: 0.25, adaptiveMarket: true, morphBonus: true, softVolConfirm: true, volPenalty: 0.9, dynamicConsec: true, consecBear: 3, consecNeutral: 5, consecBull: 6, pricePosFilter: true, pricePosThreshold: 0.95, rsFilter: true, rsThreshold: 6, dynamicRS: true, rsBear: 4, rsBull: 8, volumeRatioFilter: true, volumeRatioMin: 1.5, _minScore: 55 },
  // V44c: 动态RS(牛7/中5/熊3)+vr
  "V44c_dynrs2_vr": { v31Weight: 0.75, v10Weight: 0.25, adaptiveMarket: true, morphBonus: true, softVolConfirm: true, volPenalty: 0.9, dynamicConsec: true, consecBear: 3, consecNeutral: 5, consecBull: 6, pricePosFilter: true, pricePosThreshold: 0.95, rsFilter: true, rsThreshold: 5, dynamicRS: true, rsBear: 3, rsBull: 7, volumeRatioFilter: true, volumeRatioMin: 1.5, _minScore: 55 },
  // V44d: rs6+vr+momAlign+m55
  ...
  // V44e: rs6+vr+vc+m55
  "V44e_rs6_vr_vc_m55": { v31Weight: 0.75, v10Weight: 0.25, adaptiveMarket: true, morphBonus: true, softVolConfirm: true, volPenalty: 0.9, dynamicConsec: true, consecBear: 3, consecNeutral: 5, consecBull: 6, pricePosFilter: true, pricePosThreshold: 0.95, rsFilter: true, rsThreshold: 6, volumeRatioFilter: true, volumeRatioMin: 1.5, vcFilter: true, vcRatioThreshold: 1.1, _minScore: 55 },
  // V44f: rs6+vr13+m55 (放宽度量比)
  "V44f_rs6_vr13_m55": { v31Weight: 0.75, v10Weight: 0.25, adaptiveMarket: true, morphBonus: true, softVolConfirm: true, volPenalty: 0.9, dynamicConsec: true, consecBear: 3, consecNeutral: 5, consecBull: 6, pricePosFilter: true, pricePosThreshold: 0.95, rsFilter: true, rsThreshold: 6, volumeRatioFilter: true, volumeRatioMin: 1.3, _minScore: 55 },
  // V44g: p94+rs5+vr+m55 (放宽价格位置)
  "V44g_p94_rs5_vr_m55": { v31Weight: 0.75, v10Weight: 0.25, adaptiveMarket: true, morphBonus: true, softVolConfirm: true, volPenalty: 0.9, dynamicConsec: true, consecBear: 3, consecNeutral: 5, consecBull: 6, pricePosFilter: true, pricePosThreshold: 0.94, rsFilter: true, rsThreshold: 5, volumeRatioFilter: true, volumeRatioMin: 1.5, _minScore: 55 },
  // V44h: rs5+vr+m55+consecBear2(更严格连涨限制)
  "V44h_rs5_vr_m55_cb2": { v31Weight: 0.75, v10Weight: 0.25, adaptiveMarket: true, morphBonus: true, softVolConfirm: true, volPenalty: 0.9, dynamicConsec: true, consecBear: 2, consecNeutral: 4, consecBull: 5, pricePosFilter: true, pricePosThreshold: 0.95, rsFilter: true, rsThreshold: 5, volumeRatioFilter: true, volumeRatioMin: 1.5, _minScore: 55 },
  // V44i: 动态minScore+动态RS
  "V44i_dynrs_dynmin": { v31Weight: 0.75, v10Weight: 0.25, adaptiveMarket: true, morphBonus: true, softVolConfirm: true, volPenalty: 0.9, dynamicConsec: true, consecBear: 3, consecNeutral: 5, consecBull: 6, pricePosFilter: true, pricePosThreshold: 0.95, rsFilter: true, rsThreshold: 6, dynamicRS: true, rsBear: 4, rsBull: 8, volumeRatioFilter: true, volumeRatioMin: 1.5, dynamicMinScore: true, bearMinScore: 60, bullMinScore: 50, _minScore: 55 },
  // V44j: rs6+vr+v31_0.80+m55
  "V44j_rs6_vr_v3180_m55": { v31Weight: 0.80, v10Weight: 0.20, adaptiveMarket: true, morphBonus: true, softVolConfirm: true, volPenalty: 0.9, dynamicConsec: true, consecBear: 3, consecNeutral: 5, consecBull: 6, pricePosFilter: true, pricePosThreshold: 0.95, rsFilter: true, rsThreshold: 6, volumeRatioFilter: true, volumeRatioMin: 1.5, _minScore: 55 },
}

async function runBacktest() {
  console.log('='.repeat(60))
  console.log('V44 Strategy: Adaptive RS + Pattern Confirmation')
  console.log('='.repeat(60))
  ...
  console.log('\n' + '='.repeat(80))
  console.log('V44 Strategy Backtest - Adaptive RS + Pattern Confirmation')
  ...
  var output = []
  output.push('================================================================================')
  output.push('V44 Strategy Backtest - Adaptive RS + Pattern Confirmation')
  output.push('================================================================================')
  output.push('')
  ...
  fs.writeFileSync(path.join(CONFIG.outputDir, 'backtest_v44.txt'), output.join('\n'), 'utf8')
  console.log('\nResults saved to backtest/results/backtest_v44.txt')
}
