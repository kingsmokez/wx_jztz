...
// ===== V69策略定义 =====
// V68最佳: v68_adx20 (WR=80.09% AR=1.79% n=211)
//   = boll_squeeze + 涨幅0.5-3% + minScore=65 + 量比>=1.8 + MA10>0.02 + ADX>20
// V69: 在保持WR>78%的前提下扩大样本量
var V64_STRATEGIES = {
  "v69_base_adx20": {
    stopLoss: -100, trailingRules: [
      { profitPct: 3, trailingPct: 1 }, { profitPct: 5, trailingPct: 2 }, { profitPct: 8, trailingPct: 3 }
    ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0.02, requirePattern: 'boll_squeeze', minScore: 65, patternWeight: 2.0,
    chgMin: 0.5, chgMax: 3, vrMin: 1.8, adxMin: 20
  },
  "v69_adx18": {
    stopLoss: -100, trailingRules: [
      { profitPct: 3, trailingPct: 1 }, { profitPct: 5, trailingPct: 2 }, { profitPct: 8, trailingPct: 3 }
    ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0.02, requirePattern: 'boll_squeeze', minScore: 65, patternWeight: 2.0,
    chgMin: 0.5, chgMax: 3, vrMin: 1.8, adxMin: 18
  },
  "v69_vr15_adx20": {
    stopLoss: -100, trailingRules: [
      { profitPct: 3, trailingPct: 1 }, { profitPct: 5, trailingPct: 2 }, { profitPct: 8, trailingPct: 3 }
    ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0.02, requirePattern: 'boll_squeeze', minScore: 65, patternWeight: 2.0,
    chgMin: 0.5, chgMax: 3, vrMin: 1.5, adxMin: 20
  },
  "v69_sc60_adx20": {
    stopLoss: -100, trailingRules: [
      { profitPct: 3, trailingPct: 1 }, { profitPct: 5, trailingPct: 2 }, { profitPct: 8, trailingPct: 3 }
  ...
  "v69_chg04_adx20": {
    ...
    chgMin: 0, chgMax: 4, vrMin: 1.8, adxMin: 20
  },
  "v69_pb_bs_adx20": {
    stopLoss: -100, trailingRules: [
      { profitPct: 3, trailingPct: 1 }, { profitPct: 5, trailingPct: 2 }, { profitPct: 8, trailingPct: 3 }
    ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0.02, requirePattern: 'any', minScore: 65, patternWeight: 2.0,
    chgMin: 0.5, chgMax: 3, vrMin: 1.8, adxMin: 20, allowedPatterns: ['platform_break', 'boll_squeeze']
  },
  "v69_adx20_21d": {
    stopLoss: -100, trailingRules: [
  ...
  "v69_adx20_rsi70": {
    ...
    chgMin: 0.5, chgMax: 3, vrMin: 1.8, adxMin: 20, rsiMax: 70
  },
  "v69_adx20_ma10_003": {
    stopLoss: -100, trailingRules: [
      { profitPct: 3, trailingPct: 1 }, { profitPct: 5, trailingPct: 2 }, { profitPct: 8, trailingPct: 3 }
    ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0.03, requirePattern: 'boll_squeeze', minScore: 65, patternWeight: 2.0,
    chgMin: 0.5, chgMax: 3, vrMin: 1.8, adxMin: 20
  },
  "v69_relaxed": {
    stopLoss: -100, trailingRules: [
    ...
    chgMin: 0.5, chgMax: 4, vrMin: 1.5, adxMin: 18
  },
  "v69_pb_bs_relaxed": {
    stopLoss: -100, trailingRules: [
      { profitPct: 3, trailingPct: 1 }, { profitPct: 5, trailingPct: 2 }, { profitPct: 8, trailingPct: 3 }
    ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0.02, requirePattern: 'any', minScore: 60, patternWeight: 2.0,
    chgMin: 0.5, chgMax: 4, vrMin: 1.5, adxMin: 18, allowedPatterns: ['platform_break', 'boll_squeeze']
  },
  "v69_adx20_369": {
    stopLoss: -100, trailingRules: [
...
async function runBacktest() {
  ...
  console.log('V69 Strategy Backtest: 扩大样本量+保持高WR')
  console.log('='.repeat(80))
  ...
  var output = []
  output.push('================================================================================')
  output.push('V69 Strategy Backtest: 扩大样本量+保持高WR')
  output.push('================================================================================')
  output.push('')
  ...
  // V64base基线
  var v63BaseStats = calcDynamicStats(dynamicPicks['v69_base_adx20'] || [])
  ...
  var anyPicks = dynamicPicks['v69_base_adx20'] || []
  var patternStats = {}
  ...
  for (var s = 0; s < strategyNames.length; s++) {
    var sName = strategyNames[s]
    if (sName === 'v69_base_adx20') continue
    var stats = calcDynamicStats(dynamicPicks[sName])
  ...
  fs.writeFileSync(path.join(CONFIG.outputDir, 'backtest_v69.txt'), output.join('\n'), 'utf8')
  console.log('\nResults saved to backtest/results/backtest_v69.txt')
}
