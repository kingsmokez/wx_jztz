// run_v42.js - V42策略回测: V41e(rs5+vr)+V41c(vr18)深挖: 基于p95价格位置硬过滤深挖最优参数
var fs = require('fs')
...
var VARIANTS = {
  // V41e基准 (10dWR=59.70%, 10dAR=2.82%, n=134)
  "V41e_ref": { v31Weight: 0.75, v10Weight: 0.25, adaptiveMarket: true, morphBonus: true, softVolConfirm: true, volPenalty: 0.9, dynamicConsec: true, consecBear: 3, consecNeutral: 5, consecBull: 6, pricePosFilter: true, pricePosThreshold: 0.95, rsFilter: true, rsThreshold: 5, volumeRatioFilter: true, volumeRatioMin: 1.5, _minScore: 60 },
  // rs阈值在3-5之间微调
  "V42a_rs4_vr": { v31Weight: 0.75, v10Weight: 0.25, adaptiveMarket: true, morphBonus: true, softVolConfirm: true, volPenalty: 0.9, dynamicConsec: true, consecBear: 3, consecNeutral: 5, consecBull: 6, pricePosFilter: true, pricePosThreshold: 0.95, rsFilter: true, rsThreshold: 4, volumeRatioFilter: true, volumeRatioMin: 1.5, _minScore: 60 },
  // 量比1.3+rs5
  "V42b_rs5_vr13": { v31Weight: 0.75, v10Weight: 0.25, adaptiveMarket: true, morphBonus: true, softVolConfirm: true, volPenalty: 0.9, dynamicConsec: true, consecBear: 3, consecNeutral: 5, consecBull: 6, pricePosFilter: true, pricePosThreshold: 0.95, rsFilter: true, rsThreshold: 5, volumeRatioFilter: true, volumeRatioMin: 1.3, _minScore: 60 },
  // 量比1.8+rs5
  "V42c_rs5_vr18": { v31Weight: 0.75, v10Weight: 0.25, adaptiveMarket: true, morphBonus: true, softVolConfirm: true, volPenalty: 0.9, dynamicConsec: true, consecBear: 3, consecNeutral: 5, consecBull: 6, pricePosFilter: true, pricePosThreshold: 0.95, rsFilter: true, rsThreshold: 5, volumeRatioFilter: true, volumeRatioMin: 1.8, _minScore: 60 },
  // p96+rs5+vr
  "V42d_p96_rs5_vr": { v31Weight: 0.75, v10Weight: 0.25, adaptiveMarket: true, morphBonus: true, softVolConfirm: true, volPenalty: 0.9, dynamicConsec: true, consecBear: 3, consecNeutral: 5, consecBull: 6, pricePosFilter: true, pricePosThreshold: 0.96, rsFilter: true, rsThreshold: 5, volumeRatioFilter: true, volumeRatioMin: 1.5, _minScore: 60 },
  // rs5+vr+minScore55
  "V42e_rs5_vr_m55": { v31Weight: 0.75, v10Weight: 0.25, adaptiveMarket: true, morphBonus: true, softVolConfirm: true, volPenalty: 0.9, dynamicConsec: true, consecBear: 3, consecNeutral: 5, consecBull: 6, pricePosFilter: true, pricePosThreshold: 0.95, rsFilter: true, rsThreshold: 5, volumeRatioFilter: true, volumeRatioMin: 1.5, _minScore: 55 },
  // rs5+vr+vc(波动收缩)
  "V42f_rs5_vr_vc": { v31Weight: 0.75, v10Weight: 0.25, adaptiveMarket: true, morphBonus: true, softVolConfirm: true, volPenalty: 0.9, dynamicConsec: true, consecBear: 3, consecNeutral: 5, consecBull: 6, pricePosFilter: true, pricePosThreshold: 0.95, rsFilter: true, rsThreshold: 5, volumeRatioFilter: true, volumeRatioMin: 1.5, vcFilter: true, vcRatioThreshold: 1.1, _minScore: 60 },
  // rs5+vr+momAlign
  "V42g_rs5_vr_mom": { v31Weight: 0.75, v10Weight: 0.25, adaptiveMarket: true, morphBonus: true, softVolConfirm: true, volPenalty: 0.9, dynamicConsec: true, consecBear: 3, consecNeutral: 5, consecBull: 6, pricePosFilter: true, pricePosThreshold: 0.95, rsFilter: true, rsThreshold: 5, volumeRatioFilter: true, volumeRatioMin: 1.5, momAlignFilter: true, _minScore: 60 },
  // rs3+vr13(放宽组合)
  "V42h_rs3_vr13": { v31Weight: 0.75, v10Weight: 0.25, adaptiveMarket: true, morphBonus: true, softVolConfirm: true, volPenalty: 0.9, dynamicConsec: true, consecBear: 3, consecNeutral: 5, consecBull: 6, pricePosFilter: true, pricePosThreshold: 0.95, rsFilter: true, rsThreshold: 3, volumeRatioFilter: true, volumeRatioMin: 1.3, _minScore: 60 },
  // rs7+vr(更强的相对强度)
  "V42i_rs7_vr": { v31Weight: 0.75, v10Weight: 0.25, adaptiveMarket: true, morphBonus: true, softVolConfirm: true, volPenalty: 0.9, dynamicConsec: true, consecBear: 3, consecNeutral: 5, consecBull: 6, pricePosFilter: true, pricePosThreshold: 0.95, rsFilter: true, rsThreshold: 7, volumeRatioFilter: true, volumeRatioMin: 1.5, _minScore: 60 },
  // rs10+vr(20日涨幅>10%)
  "V42j_rs10_vr": { v31Weight: 0.75, v10Weight: 0.25, adaptiveMarket: true, morphBonus: true, softVolConfirm: true, volPenalty: 0.9, dynamicConsec: true, consecBear: 3, consecNeutral: 5, consecBull: 6, pricePosFilter: true, pricePosThreshold: 0.95, rsFilter: true, rsThreshold: 10, volumeRatioFilter: true, volumeRatioMin: 1.5, _minScore: 60 },
  // rs5+vr+v31_0.80
  "V42k_rs5_vr_v3180": { v31Weight: 0.80, v10Weight: 0.20, adaptiveMarket: true, morphBonus: true, softVolConfirm: true, volPenalty: 0.9, dynamicConsec: true, consecBear: 3, consecNeutral: 5, consecBull: 6, pricePosFilter: true, pricePosThreshold: 0.95, rsFilter: true, rsThreshold: 5, volumeRatioFilter: true, volumeRatioMin: 1.5, _minScore: 60 },
  // rs5+vr+动态minScore
  "V42l_rs5_vr_dynmin": { v31Weight: 0.75, v10Weight: 0.25, adaptiveMarket: true, morphBonus: true, softVolConfirm: true, volPenalty: 0.9, dynamicConsec: true, consecBear: 3, consecNeutral: 5, consecBull: 6, pricePosFilter: true, pricePosThreshold: 0.95, rsFilter: true, rsThreshold: 5, volumeRatioFilter: true, volumeRatioMin: 1.5, dynamicMinScore: true, bearMinScore: 65, bullMinScore: 55, _minScore: 60 },
}

async function runBacktest() {
  console.log('='.repeat(60))
  console.log('V42 Strategy: V41e(rs5+vr) + Breakout Confirmation')
  console.log('='.repeat(60))
  ...
  console.log('\n' + '='.repeat(80))
  console.log('V42 Strategy Backtest - V41e(rs5+vr) + Breakout Confirmation')
  ...
  var output = []
  output.push('================================================================================')
  output.push('V42 Strategy Backtest - V41e(rs5+vr) + Breakout Confirmation')
  output.push('================================================================================')
  output.push('')
  ...
  fs.writeFileSync(path.join(CONFIG.outputDir, 'backtest_v42.txt'), output.join('\n'), 'utf8')
  console.log('\nResults saved to backtest/results/backtest_v42.txt')
}
