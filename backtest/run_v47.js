...
var EXIT_STRATEGIES = {
  ...
  // V46i基准: 无止损+阶梯5/8/12%
  "V46i_ref": { stopLoss: -100, trailingRules: [
    { profitPct: 5, trailingPct: 2 },
    { profitPct: 8, trailingPct: 3 },
    { profitPct: 12, trailingPct: 4 }
  ], maxHoldDays: 10 },
  // V47a: 更早止盈(3%回撤1.5%)
  "V47a_3pct_1.5": { stopLoss: -100, trailingRules: [
    { profitPct: 3, trailingPct: 1.5 }
  ], maxHoldDays: 10 },
  // V47b: 4%回撤2%
  "V47b_4pct_2": { stopLoss: -100, trailingRules: [
    { profitPct: 4, trailingPct: 2 }
  ], maxHoldDays: 10 },
  // V47c: 6%回撤2.5%
  "V47c_6pct_2.5": { stopLoss: -100, trailingRules: [
    { profitPct: 6, trailingPct: 2.5 }
  ], maxHoldDays: 10 },
  // V47d: 8%回撤3%
  "V47d_8pct_3": { stopLoss: -100, trailingRules: [
    { profitPct: 8, trailingPct: 3 }
  ], maxHoldDays: 10 },
  // V47e: 10%回撤3.5%
  "V47e_10pct_3.5": { stopLoss: -100, trailingRules: [
    { profitPct: 10, trailingPct: 3.5 }
  ], maxHoldDays: 10 },
  // V47f: 阶梯3%/1.5% + 6%/2.5% + 10%/4%
  "V47f_stair_3_6_10": { stopLoss: -100, trailingRules: [
    { profitPct: 3, trailingPct: 1.5 },
    { profitPct: 6, trailingPct: 2.5 },
    { profitPct: 10, trailingPct: 4 }
  ], maxHoldDays: 10 },
  // V47g: 阶梯4%/2% + 8%/3% + 15%/5%
  "V47g_stair_4_8_15": { stopLoss: -100, trailingRules: [
    { profitPct: 4, trailingPct: 2 },
    { profitPct: 8, trailingPct: 3 },
    { profitPct: 15, trailingPct: 5 }
  ], maxHoldDays: 10 },
  // V47h: V46i + 最大持有14天
  "V47h_14d": { stopLoss: -100, trailingRules: [
    { profitPct: 5, trailingPct: 2 },
    { profitPct: 8, trailingPct: 3 },
    { profitPct: 12, trailingPct: 4 }
  ], maxHoldDays: 14 },
  // V47i: V46i + 最大持有7天
  "V47i_7d": { stopLoss: -100, trailingRules: [
    { profitPct: 5, trailingPct: 2 },
    { profitPct: 8, trailingPct: 3 },
    { profitPct: 12, trailingPct: 4 }
  ], maxHoldDays: 7 },
  // V47j: 5%回撤3%(更宽松回撤)
  "V47j_5pct_3": { stopLoss: -100, trailingRules: [
    { profitPct: 5, trailingPct: 3 }
  ], maxHoldDays: 10 },
  // V47k: 阶梯5%/2% + 10%/3.5%
  "V47k_stair_5_10": { stopLoss: -100, trailingRules: [
    { profitPct: 5, trailingPct: 2 },
    { profitPct: 10, trailingPct: 3.5 }
  ], maxHoldDays: 10 },
  // V47l: 阶梯5%/3% + 10%/4%(更宽松)
  "V47l_stair_5_10_lax": { stopLoss: -100, trailingRules: [
    { profitPct: 5, trailingPct: 3 },
    { profitPct: 10, trailingPct: 4 }
  ], maxHoldDays: 10 },
  // V47m: 固定持有14天(无止盈)
  "V47m_fixed14d": { stopLoss: -100, trailingRules: [], maxHoldDays: 14 },
}

async function runBacktest() {
  console.log('='.repeat(80))
  console.log('V47 Strategy Backtest: V46i参数扫描(无止损+移动止盈)')
  console.log('='.repeat(80))
  ...
  var output = []
  output.push('================================================================================')
  output.push('V47 Strategy Backtest: V46i参数扫描(无止损+移动止盈)')
  output.push('================================================================================')
  output.push('')
  ...
  fs.writeFileSync(path.join(CONFIG.outputDir, 'backtest_v47.txt'), output.join('\n'), 'utf8')
  console.log('\nResults saved to backtest/results/backtest_v47.txt')
}
