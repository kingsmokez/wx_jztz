// run_v76.js - V76策略回测: 基于V75结果的精细搜索
// V75发现: MACD确认最有效(WR=91.67%)但样本少, ADX30确认较平衡(WR=85.37%,n=41)
// V76目标: 找到WR>=82%且n>=60的策略组合
// 方法: 放宽boll参数 + 多种二次确认组合 + 采样间隔从3天改为2天增加样本
var fs = require('fs')
...
function calcPatternScoreV76(stock, klines, dateIdx, tech, volumeRatio, bollWidthMax) {
...
function simulatePickV76(dayQuotes, klineMap, dateIdxMap, topN, marketEnv, strategy) {
  ...
  for (var i = 0; i < dayQuotes.length; i++) {
    ...
    var patternResult = calcPatternScoreV76(stock, klines, dateIdx, tech, volumeRatio, strategy.bollWidthMax)
...
// V76策略: 在V75最佳结果基础上精细搜索
// 核心发现: ADX30和MACD确认最有效，需要放宽boll参数来增加样本
var V76_STRATEGIES = {
  // 基准复现
  "v76_v73base": Object.assign({}, BASE_EXIT, {
  ...
  // === boll宽度0.09 + 各种确认组合 ===
  "v76_bw09_adx28": Object.assign({}, BASE_EXIT, {
    ma5Min: 0.1, ma10Min: 0.02, requirePattern: 'boll_squeeze',
    minScore: 60, patternWeight: 2.0, bollWidthMax: 0.09,
    chgMin: 1, chgMax: 2.5, vrMin: 1.5, rsiMax: 60,
    confirmADX: 28
  }),
  "v76_bw09_adx30": Object.assign({}, BASE_EXIT, {
    ma5Min: 0.1, ma10Min: 0.02, requirePattern: 'boll_squeeze',
    minScore: 60, patternWeight: 2.0, bollWidthMax: 0.09,
    chgMin: 1, chgMax: 2.5, vrMin: 1.5, rsiMax: 60,
    confirmADX: 30
  }),
  "v76_bw09_macd": Object.assign({}, BASE_EXIT, {
    ma5Min: 0.1, ma10Min: 0.02, requirePattern: 'boll_squeeze',
    minScore: 60, patternWeight: 2.0, bollWidthMax: 0.09,
    chgMin: 1, chgMax: 2.5, vrMin: 1.5, rsiMax: 60,
    confirmMACD: true
  }),
  "v76_bw09_macdpos": Object.assign({}, BASE_EXIT, {
    ma5Min: 0.1, ma10Min: 0.02, requirePattern: 'boll_squeeze',
    minScore: 60, patternWeight: 2.0, bollWidthMax: 0.09,
    chgMin: 1, chgMax: 2.5, vrMin: 1.5, rsiMax: 60,
    confirmMACDPos: true
  }),
  "v76_bw09_obv": Object.assign({}, BASE_EXIT, {
    ma5Min: 0.1, ma10Min: 0.02, requirePattern: 'boll_squeeze',
    minScore: 60, patternWeight: 2.0, bollWidthMax: 0.09,
    chgMin: 1, chgMax: 2.5, vrMin: 1.5, rsiMax: 60,
    confirmOBV: true
  }),
  "v76_bw09_ma20": Object.assign({}, BASE_EXIT, {
    ma5Min: 0.1, ma10Min: 0.02, requirePattern: 'boll_squeeze',
    minScore: 60, patternWeight: 2.0, bollWidthMax: 0.09,
    chgMin: 1, chgMax: 2.5, vrMin: 1.5, rsiMax: 60,
    confirmAboveMA20: true
  }),
  // boll 0.09 + 双确认
  "v76_bw09_adx25_macdpos": Object.assign({}, BASE_EXIT, {
    ma5Min: 0.1, ma10Min: 0.02, requirePattern: 'boll_squeeze',
    minScore: 60, patternWeight: 2.0, bollWidthMax: 0.09,
    chgMin: 1, chgMax: 2.5, vrMin: 1.5, rsiMax: 60,
    confirmADX: 25, confirmMACDPos: true
  }),
  "v76_bw09_adx25_obv": Object.assign({}, BASE_EXIT, {
    ma5Min: 0.1, ma10Min: 0.02, requirePattern: 'boll_squeeze',
    minScore: 60, patternWeight: 2.0, bollWidthMax: 0.09,
    chgMin: 1, chgMax: 2.5, vrMin: 1.5, rsiMax: 60,
    confirmADX: 25, confirmOBV: true
  }),
  "v76_bw09_macdpos_obv": Object.assign({}, BASE_EXIT, {
    ma5Min: 0.1, ma10Min: 0.02, requirePattern: 'boll_squeeze',
    minScore: 60, patternWeight: 2.0, bollWidthMax: 0.09,
    chgMin: 1, chgMax: 2.5, vrMin: 1.5, rsiMax: 60,
    confirmMACDPos: true, confirmOBV: true
  }),
  "v76_bw09_adx25_ma20": Object.assign({}, BASE_EXIT, {
    ma5Min: 0.1, ma10Min: 0.02, requirePattern: 'boll_squeeze',
    minScore: 60, patternWeight: 2.0, bollWidthMax: 0.09,
    chgMin: 1, chgMax: 2.5, vrMin: 1.5, rsiMax: 60,
    confirmADX: 25, confirmAboveMA20: true
  }),

  // === boll宽度0.085 + 确认 ===
  "v76_bw085_adx28": Object.assign({}, BASE_EXIT, {
    ma5Min: 0.1, ma10Min: 0.02, requirePattern: 'boll_squeeze',
    minScore: 62, patternWeight: 2.0, bollWidthMax: 0.085,
    chgMin: 1, chgMax: 2.5, vrMin: 1.5, rsiMax: 60,
    confirmADX: 28
  }),
  "v76_bw085_macdpos": Object.assign({}, BASE_EXIT, {
    ma5Min: 0.1, ma10Min: 0.02, requirePattern: 'boll_squeeze',
    minScore: 62, patternWeight: 2.0, bollWidthMax: 0.085,
    chgMin: 1, chgMax: 2.5, vrMin: 1.5, rsiMax: 60,
    confirmMACDPos: true
  }),
  "v76_bw085_adx25_obv": Object.assign({}, BASE_EXIT, {
    ma5Min: 0.1, ma10Min: 0.02, requirePattern: 'boll_squeeze',
    minScore: 62, patternWeight: 2.0, bollWidthMax: 0.085,
    chgMin: 1, chgMax: 2.5, vrMin: 1.5, rsiMax: 60,
    confirmADX: 25, confirmOBV: true
  ...
  // === 放宽涨幅 + 确认 ===
  "v76_chg05_3_adx30": Object.assign({}, BASE_EXIT, {
    ma5Min: 0.1, ma10Min: 0.02, requirePattern: 'boll_squeeze',
    minScore: 60, patternWeight: 2.0,
    chgMin: 0.5, chgMax: 3, vrMin: 1.5, rsiMax: 65,
    confirmADX: 30
  }),
  "v76_chg05_3_macdpos": Object.assign({}, BASE_EXIT, {
    ma5Min: 0.1, ma10Min: 0.02, requirePattern: 'boll_squeeze',
    minScore: 60, patternWeight: 2.0,
    chgMin: 0.5, chgMax: 3, vrMin: 1.5, rsiMax: 65,
    confirmMACDPos: true
  }),
  "v76_chg05_3_obv": Object.assign({}, BASE_EXIT, {
    ma5Min: 0.1, ma10Min: 0.02, requirePattern: 'boll_squeeze',
    minScore: 60, patternWeight: 2.0,
    chgMin: 0.5, chgMax: 3, vrMin: 1.5, rsiMax: 65,
    confirmOBV: true
  ...
  // === 组合: 放宽boll+放宽涨幅+确认 ===
  "v76_bw09_chg05_adx28": Object.assign({}, BASE_EXIT, {
    ma5Min: 0.1, ma10Min: 0.02, requirePattern: 'boll_squeeze',
    minScore: 58, patternWeight: 2.0, bollWidthMax: 0.09,
    chgMin: 0.5, chgMax: 3, vrMin: 1.5, rsiMax: 65,
    confirmADX: 28
  }),
  "v76_bw09_chg05_obv": Object.assign({}, BASE_EXIT, {
    ma5Min: 0.1, ma10Min: 0.02, requirePattern: 'boll_squeeze',
    minScore: 58, patternWeight: 2.0, bollWidthMax: 0.09,
    chgMin: 0.5, chgMax: 3, vrMin: 1.5, rsiMax: 65,
    confirmOBV: true
  }),
  "v76_bw09_chg05_ma20": Object.assign({}, BASE_EXIT, {
    ma5Min: 0.1, ma10Min: 0.02, requirePattern: 'boll_squeeze',
    minScore: 58, patternWeight: 2.0, bollWidthMax: 0.09,
    chgMin: 0.5, chgMax: 3, vrMin: 1.5, rsiMax: 65,
    confirmAboveMA20: true
  }),
  "v76_bw09_chg05_macdpos_obv": Object.assign({}, BASE_EXIT, {
    ma5Min: 0.1, ma10Min: 0.02, requirePattern: 'boll_squeeze',
    minScore: 58, patternWeight: 2.0, bollWidthMax: 0.09,
    chgMin: 0.5, chgMax: 3, vrMin: 1.5, rsiMax: 65,
    confirmMACDPos: true, confirmOBV: true
  ...
  // === 止盈优化 ===
  "v76_bw09_adx28_4710": Object.assign({}, BASE_EXIT, {
    ma5Min: 0.1, ma10Min: 0.02, requirePattern: 'boll_squeeze',
    minScore: 60, patternWeight: 2.0, bollWidthMax: 0.09,
    chgMin: 1, chgMax: 2.5, vrMin: 1.5, rsiMax: 60,
    confirmADX: 28,
  ...
  "v76_bw09_adx30_4710": Object.assign({}, BASE_EXIT, {
    ma5Min: 0.1, ma10Min: 0.02, requirePattern: 'boll_squeeze',
    minScore: 60, patternWeight: 2.0, bollWidthMax: 0.09,
    chgMin: 1, chgMax: 2.5, vrMin: 1.5, rsiMax: 60,
    confirmADX: 30,
...
async function runBacktest() {
  ...
  console.log('V76 Strategy Backtest: 精细搜索 (基于V75结果)')
  console.log('='.repeat(80))
  ...
  var strategyNames = Object.keys(V76_STRATEGIES)
  var dynamicPicks = {}
  ...
  for (var si = 0; si < sampleDates.length; si++) {
    ...
    for (var s = 0; s < strategyNames.length; s++) {
      ...
      var strategy = V76_STRATEGIES[sName]
      var picks = simulatePickV76(dayQuotes, klineMap, dateIdxMap, CONFIG.topN, marketEnv, strategy)
  ...
  var output = []
  output.push('V76 Backtest Results: 精细搜索 (基于V75)')
  ...
  fs.writeFileSync(path.join(CONFIG.outputDir, 'backtest_v76.txt'), output.join('\n'), 'utf8')
  console.log('\nResults saved to backtest/results/backtest_v76.txt')
