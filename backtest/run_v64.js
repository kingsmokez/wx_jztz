...
function simulatePickV64(dayQuotes, klineMap, dateIdxMap, topN, marketEnv, strategy) {
  ...
  for (var i = 0; i < dayQuotes.length; i++) {
    ...
    // 如果策略要求特定形态，过滤
    if (strategy.requirePattern && patternName !== strategy.requirePattern && patternName !== 'none') {
      if (strategy.requirePattern === 'any' && patternName === 'none') continue
      else if (strategy.requirePattern !== 'any' && patternName !== strategy.requirePattern) continue
    }
    if (strategy.requirePattern === 'any' && patternName === 'none') continue
...
var V64_STRATEGIES = {
  ...
  "v63_gapUp": {
    ...
    ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0, requireGapUp: true, minScore: 55, patternWeight: 1.0
  },
  // V64: 任意形态（5种形态取并集）
  "v64_any_pattern": {
    stopLoss: -100, trailingRules: [
  ...
  "v64_platform": {
    stopLoss: -100, trailingRules: [
      { profitPct: 3, trailingPct: 1 }, { profitPct: 5, trailingPct: 2 }, { profitPct: 8, trailingPct: 3 }
    ], maxHoldDays: 18, ma5Min: 0, ma10Min: 0, requirePattern: 'platform_break', minScore: 50, patternWeight: 2.0
  },
  // V64: 仅趋势加速
  "v64_trend_accel": {
    stopLoss: -100, trailingRules: [
      { profitPct: 3, trailingPct: 1 }, { profitPct: 5, trailingPct: 2 }, { profitPct: 8, trailingPct: 3 }
    ], maxHoldDays: 18, ma5Min: 0.15, ma10Min: 0, requirePattern: 'trend_accel', minScore: 50, patternWeight: 2.0
  },
  // V64: 仅缩量回踩
  "v64_pullback": {
    stopLoss: -100, trailingRules: [
      { profitPct: 3, trailingPct: 1 }, { profitPct: 5, trailingPct: 2 }, { profitPct: 8, trailingPct: 3 }
    ], maxHoldDays: 18, ma5Min: 0, ma10Min: 0, requirePattern: 'pullback_restart', minScore: 50, patternWeight: 2.0
  },
  // V64: 仅布林收窄突破
  "v64_boll_squeeze": {
    stopLoss: -100, trailingRules: [
      { profitPct: 3, trailingPct: 1 }, { profitPct: 5, trailingPct: 2 }, { profitPct: 8, trailingPct: 3 }
    ], maxHoldDays: 18, ma5Min: 0, ma10Min: 0, requirePattern: 'boll_squeeze', minScore: 50, patternWeight: 2.0
  },
  // V64: any形态 + 更宽松MA5
  "v64_any_m5_006": {
    stopLoss: -100, trailingRules: [
      { profitPct: 3, trailingPct: 1 }, { profitPct: 5, trailingPct: 2 }, { profitPct: 8, trailingPct: 3 }
    ], maxHoldDays: 18, ma5Min: 0.06, ma10Min: 0, requirePattern: 'any', minScore: 55, patternWeight: 1.5
  },
  // V64: any形态 + 更高形态权重
  "v64_any_pw25": {
    stopLoss: -100, trailingRules: [
      { profitPct: 3, trailingPct: 1 }, { profitPct: 5, trailingPct: 2 }, { profitPct: 8, trailingPct: 3 }
    ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0, requirePattern: 'any', minScore: 55, patternWeight: 2.5
  },
  // V64: any形态 + 4tier止盈
  "v64_any_4tier": {
    stopLoss: -100, trailingRules: [
  ...
  // V64: gapUp或平台突破（混合形态1+2）
  "v64_gap_or_platform": {
    stopLoss: -100, trailingRules: [
      { profitPct: 3, trailingPct: 1 }, { profitPct: 5, trailingPct: 2 }, { profitPct: 8, trailingPct: 3 }
    ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0, requirePattern: 'any', minScore: 55, patternWeight: 1.5
  },
  // V64: any形态 + minScore=60(更严格)
  "v64_any_sc60": {
    stopLoss: -100, trailingRules: [
      { profitPct: 3, trailingPct: 1 }, { profitPct: 5, trailingPct: 2 }, { profitPct: 8, trailingPct: 3 }
    ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0, requirePattern: 'any', minScore: 60, patternWeight: 1.5
  },
  // V64: any形态 + ADX>=22(趋势确认)
  "v64_any_adx22": {
    stopLoss: -100, trailingRules: [
      { profitPct: 3, trailingPct: 1 }, { profitPct: 5, trailingPct: 2 }, { profitPct: 8, trailingPct: 3 }
    ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0, requirePattern: 'any', minScore: 55, patternWeight: 1.5, adxMin: 22
  },
  // V64: 任意形态 + 3/6/10%阶梯(更宽松回撤)
  "v64_any_3610": {
    stopLoss: -100, trailingRules: [
      { profitPct: 3, trailingPct: 1.5 }, { profitPct: 6, trailingPct: 2 }, { profitPct: 10, trailingPct: 3 }
    ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0.02, requirePattern: 'any', minScore: 55, patternWeight: 1.5
  },
  // V64: any形态 + 无MA10过滤
  "v64_any_noMA10": {
    stopLoss: -100, trailingRules: [
      { profitPct: 3, trailingPct: 1 }, { profitPct: 5, trailingPct: 2 }, { profitPct: 8, trailingPct: 3 }
    ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: -Infinity, requirePattern: 'any', minScore: 55, patternWeight: 1.5
  },
}

async function runBacktest() {
  console.log('='.repeat(80))
  console.log('V64 Strategy Backtest: 多形态融合 + 动态止盈')
  console.log('='.repeat(80))
  ...
  var output = []
  output.push('================================================================================')
  output.push('V64 Strategy Backtest: 多形态融合 + 动态止盈')
  output.push('================================================================================')
  output.push('')
  ...
  summaryLines.push('')
  summaryLines.push('Strategy'.padEnd(24) + '  n   WR%   AR%  AvgD  vsV63WR  vsV63AR  PatternBreakdown')
  summaryLines.push('-'.repeat(110))

  // V63基线
  var v63BaseStats = calcDynamicStats(dynamicPicks['v63_gapUp'])
  var v63WR = v63BaseStats.winRate
  var v63AR = v63BaseStats.avgReturn
  ...
  for (var s = 0; s < strategyNames.length; s++) {
    ...
    var wrDiff = (stats.winRate - v63WR).toFixed(2)
    var arDiff = (stats.avgReturn - v63AR).toFixed(2)
    ...
    if (stats.winRate > v63WR && stats.avgReturn > v63AR) {
      console.log('>>> ' + sName + ': WR=' + stats.winRate + '% AR=' + stats.avgReturn + '% avgDay=' + stats.avgExitDay + ' BEATS V63!')
    }
  }
  ...
  var anyPicks = dynamicPicks['v64_any_pattern'] || []
  var patternStats = {}
  ...
  output.push('| V63 | gapUp+3/5/8% | ' + v63WR + ' | ' + v63AR + ' | ' + v63BaseStats.total + ' | ' + v63BaseStats.avgExitDay + ' |')
  ...
  fs.writeFileSync(path.join(CONFIG.outputDir, 'backtest_v64.txt'), output.join('\n'), 'utf8')
  console.log('\nResults saved to backtest/results/backtest_v64.txt')
}
