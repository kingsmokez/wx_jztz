...
var V64_STRATEGIES = {
  ...
  "v70_chg05_2": {
    ...
    chgMin: 0.5, chgMax: 2, vrMin: 1.8, adxMin: 20
  },
  "v70_4710": {
    stopLoss: -100, trailingRules: [
  ...
  "v70_adx25": {
    ...
    chgMin: 0.5, chgMax: 3, vrMin: 1.8, adxMin: 25
  },
  "v70_sc70": {
    stopLoss: -100, trailingRules: [
      { profitPct: 3, trailingPct: 1 }, { profitPct: 5, trailingPct: 2 }, { profitPct: 8, trailingPct: 3 }
  ...
  "v70_vr20": {
    ...
    chgMin: 0.5, chgMax: 3, vrMin: 2.0, adxMin: 20
  },
  "v70_pb_bs_21d": {
    stopLoss: -100, trailingRules: [
      { profitPct: 3, trailingPct: 1 }, { profitPct: 5, trailingPct: 2 }, { profitPct: 8, trailingPct: 3 }, { profitPct: 12, trailingPct: 4 }
  ...
  "v70_ma10_003": {
    stopLoss: -100, trailingRules: [
      { profitPct: 3, trailingPct: 1 }, { profitPct: 5, trailingPct: 2 }, { profitPct: 8, trailingPct: 3 }
    ], maxHoldDays: 21, ma5Min: 0.1, ma10Min: 0.03, requirePattern: 'boll_squeeze', minScore: 65, patternWeight: 2.0,
    chgMin: 0.5, chgMax: 3, vrMin: 1.8, adxMin: 20
  },
  "v70_ma5_015": {
    stopLoss: -100, trailingRules: [
...
async function runBacktest() {
  ...
  console.log('V70 Strategy Backtest: NaN修复+深度优化')
  console.log('='.repeat(80))
  ...
  var output = []
  output.push('================================================================================')
  output.push('V70 Strategy Backtest: NaN修复+深度优化')
  output.push('================================================================================')
  output.push('')
  ...
  // V64base基线
  var v63BaseStats = calcDynamicStats(dynamicPicks['v70_base'] || [])
  ...
  var anyPicks = dynamicPicks['v70_base'] || []
  var patternStats = {}
