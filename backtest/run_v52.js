...
var EXIT_STRATEGIES = {
  // === V52: 在V51最优(tight_v1 WR=73.13%)基础上精调 ===
  // 组1: 微调trailing参数
  "v1_base": { stopLoss: -100, trailingRules: [
    { profitPct: 3, trailingPct: 1 }, { profitPct: 6, trailingPct: 2 }, { profitPct: 10, trailingPct: 3 }
  ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0 },
  "v1_h20": { stopLoss: -100, trailingRules: [
    { profitPct: 3, trailingPct: 1 }, { profitPct: 6, trailingPct: 2 }, { profitPct: 10, trailingPct: 3 }
  ], maxHoldDays: 20, ma5Min: 0.1, ma10Min: 0 },
  "v1_h16": { stopLoss: -100, trailingRules: [
    { profitPct: 3, trailingPct: 1 }, { profitPct: 6, trailingPct: 2 }, { profitPct: 10, trailingPct: 3 }
  ], maxHoldDays: 16, ma5Min: 0.1, ma10Min: 0 },
  // 组2: trailing微调 - 第1档利润/回撤
  "v1_p2.5_t0.8": { stopLoss: -100, trailingRules: [
    { profitPct: 2.5, trailingPct: 0.8 }, { profitPct: 6, trailingPct: 2 }, { profitPct: 10, trailingPct: 3 }
  ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0 },
  "v1_p3.5_t1.2": { stopLoss: -100, trailingRules: [
    { profitPct: 3.5, trailingPct: 1.2 }, { profitPct: 6, trailingPct: 2 }, { profitPct: 10, trailingPct: 3 }
  ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0 },
  "v1_p3_t1.5": { stopLoss: -100, trailingRules: [
    { profitPct: 3, trailingPct: 1.5 }, { profitPct: 6, trailingPct: 2 }, { profitPct: 10, trailingPct: 3 }
  ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0 },
  // 组3: 第2档微调
  "v1_m2_p5_t1.5": { stopLoss: -100, trailingRules: [
    { profitPct: 3, trailingPct: 1 }, { profitPct: 5, trailingPct: 1.5 }, { profitPct: 10, trailingPct: 3 }
  ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0 },
  "v1_m2_p7_t2.5": { stopLoss: -100, trailingRules: [
    { profitPct: 3, trailingPct: 1 }, { profitPct: 7, trailingPct: 2.5 }, { profitPct: 10, trailingPct: 3 }
  ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0 },
  // 组4: 第3档微调
  "v1_m3_p8_t2.5": { stopLoss: -100, trailingRules: [
    { profitPct: 3, trailingPct: 1 }, { profitPct: 6, trailingPct: 2 }, { profitPct: 8, trailingPct: 2.5 }
  ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0 },
  "v1_m3_p12_t3.5": { stopLoss: -100, trailingRules: [
    { profitPct: 3, trailingPct: 1 }, { profitPct: 6, trailingPct: 2 }, { profitPct: 12, trailingPct: 3.5 }
  ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0 },
  // 组5: MA5阈值微调+tight_v1退出
  "v1_ma5_008": { stopLoss: -100, trailingRules: [
    { profitPct: 3, trailingPct: 1 }, { profitPct: 6, trailingPct: 2 }, { profitPct: 10, trailingPct: 3 }
  ], maxHoldDays: 18, ma5Min: 0.08, ma10Min: 0 },
  "v1_ma5_012": { stopLoss: -100, trailingRules: [
    { profitPct: 3, trailingPct: 1 }, { profitPct: 6, trailingPct: 2 }, { profitPct: 10, trailingPct: 3 }
  ], maxHoldDays: 18, ma5Min: 0.12, ma10Min: 0 },
  "v1_ma5_015": { stopLoss: -100, trailingRules: [
    { profitPct: 3, trailingPct: 1 }, { profitPct: 6, trailingPct: 2 }, { profitPct: 10, trailingPct: 3 }
  ], maxHoldDays: 18, ma5Min: 0.15, ma10Min: 0 },
  // 组6: MA10阈值微调
  "v1_ma10_002": { stopLoss: -100, trailingRules: [
    { profitPct: 3, trailingPct: 1 }, { profitPct: 6, trailingPct: 2 }, { profitPct: 10, trailingPct: 3 }
  ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0.02 },
  "v1_ma10_005": { stopLoss: -100, trailingRules: [
    { profitPct: 3, trailingPct: 1 }, { profitPct: 6, trailingPct: 2 }, { profitPct: 10, trailingPct: 3 }
  ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0.05 },
  // 组7: 4档trailing(更精细)
  "v1_4tier": { stopLoss: -100, trailingRules: [
    { profitPct: 2, trailingPct: 0.5 }, { profitPct: 4, trailingPct: 1 }, { profitPct: 7, trailingPct: 2 }, { profitPct: 10, trailingPct: 3 }
  ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0 },
  "v1_4tier_h20": { stopLoss: -100, trailingRules: [
    { profitPct: 2, trailingPct: 0.5 }, { profitPct: 4, trailingPct: 1 }, { profitPct: 7, trailingPct: 2 }, { profitPct: 10, trailingPct: 3 }
  ], maxHoldDays: 20, ma5Min: 0.1, ma10Min: 0 }
}
...
async function runBacktest() {
  ...
  var output = []
  output.push('================================================================================')
  output.push('V52 Strategy Backtest: tight_v1精调(3%利润1%回撤)')
  output.push('================================================================================')
  output.push('')
  ...
  fs.writeFileSync(path.join(CONFIG.outputDir, 'backtest_v52.txt'), output.join('\n'), 'utf8')
