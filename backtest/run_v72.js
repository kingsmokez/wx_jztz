...
var V72_STRATEGIES = {
  ...
  "v72_rsi55": {
    ...
    chgMin: 1, chgMax: 2.5, vrMin: 1.8, adxMin: 20, rsiMax: 55
  },
  "v72_rsi65_sc70": {
    stopLoss: -100, trailingRules: [
      { profitPct: 3, trailingPct: 1 }, { profitPct: 5, trailingPct: 2 }, { profitPct: 8, trailingPct: 3 }
  ...
  "v72_rsi65_sc75": {
    stopLoss: -100, trailingRules: [
      { profitPct: 3, trailingPct: 1 }, { profitPct: 5, trailingPct: 2 }, { profitPct: 8, trailingPct: 3 }
    ], maxHoldDays: 21, ma5Min: 0.1, ma10Min: 0.02, requirePattern: 'boll_squeeze', minScore: 75, patternWeight: 2.0,
    chgMin: 1, chgMax: 2.5, vrMin: 1.8, adxMin: 20, rsiMax: 65
  },
  "v72_rsi65_4710": {
    stopLoss: -100, trailingRules: [
  ...
  "v72_rsi65_vr20": {
    ...
    chgMin: 1, chgMax: 2.5, vrMin: 2.0, adxMin: 20, rsiMax: 65
  },
  "v72_rsi65_adx25": {
    stopLoss: -100, trailingRules: [
      { profitPct: 3, trailingPct: 1 }, { profitPct: 5, trailingPct: 2 }, { profitPct: 8, trailingPct: 3 }
    ], maxHoldDays: 21, ma5Min: 0.1, ma10Min: 0.02, requirePattern: 'boll_squeeze', minScore: 65, patternWeight: 2.0,
    chgMin: 1, chgMax: 2.5, vrMin: 1.8, adxMin: 25, rsiMax: 65
  },
  "v72_rsi65_chg08_2": {
    stopLoss: -100, trailingRules: [
      { profitPct: 3, trailingPct: 1 }, { profitPct: 5, trailingPct: 2 }, { profitPct: 8, trailingPct: 3 }
    ], maxHoldDays: 21, ma5Min: 0.1, ma10Min: 0.02, requirePattern: 'boll_squeeze', minScore: 65, patternWeight: 2.0,
    chgMin: 0.8, chgMax: 2, vrMin: 1.8, adxMin: 20, rsiMax: 65
  },
  "v72_rsi65_chg12_3": {
    stopLoss: -100, trailingRules: [
      { profitPct: 3, trailingPct: 1 }, { profitPct: 5, trailingPct: 2 }, { profitPct: 8, trailingPct: 3 }
    ], maxHoldDays: 21, ma5Min: 0.1, ma10Min: 0.02, requirePattern: 'boll_squeeze', minScore: 65, patternWeight: 2.0,
    chgMin: 1.2, chgMax: 3, vrMin: 1.8, adxMin: 20, rsiMax: 65
  },
  "v72_rsi65_ma5_015": {
    stopLoss: -100, trailingRules: [
      { profitPct: 3, trailingPct: 1 }, { profitPct: 5, trailingPct: 2 }, { profitPct: 8, trailingPct: 3 }
...
async function runBacktest() {
  ...
  console.log('V72 Strategy Backtest: RSI精细优化+评分门槛+止盈参数')
  console.log('='.repeat(80))
  ...
  // 运行各策略
  var strategyNames = Object.keys(V72_STRATEGIES)
  var dynamicPicks = {}
  var patternCounts = {}
  ...
  for (var si = 0; si < sampleDates.length; si++) {
    ...
    for (var s = 0; s < strategyNames.length; s++) {
      ...
      var strategy = V72_STRATEGIES[sName]
  ...
  var output = []
  output.push('================================================================================')
  output.push('V72 Strategy Backtest: RSI精细优化+评分门槛+止盈参数')
  output.push('================================================================================')
  output.push('')
  ...
  summaryLines.push('')
  summaryLines.push('Strategy'.padEnd(24) + '  n   WR%   AR%  AvgD  vsV71baseWR  vsV71baseAR  PatternBreakdown')
  summaryLines.push('-'.repeat(110))

  // V71base基线
  var v71BaseStats = calcDynamicStats(dynamicPicks['v72_v71base'] || [])
  var v71BaseWR = v71BaseStats.winRate
  var v71BaseAR = v71BaseStats.avgReturn
  ...
  for (var s = 0; s < strategyNames.length; s++) {
    ...
    var wrDiff = (stats.winRate - v71BaseWR).toFixed(2)
    var arDiff = (stats.avgReturn - v71BaseAR).toFixed(2)
    ...
    if (stats.winRate > v71BaseWR && stats.avgReturn > v71BaseAR) {
      console.log('>>> ' + sName + ': WR=' + stats.winRate + '% AR=' + stats.avgReturn + '% avgDay=' + stats.avgExitDay + ' BEATS V71base!')
    }
  }
  ...
  var anyPicks = dynamicPicks['v72_v71base'] || []
  var patternStats = {}
  ...
  output.push('| V71base | gapUp+3/5/8% | ' + v71BaseWR + ' | ' + v71BaseAR + ' | ' + v71BaseStats.total + ' | ' + v71BaseStats.avgExitDay + ' |')
  
  // 找最佳V64策略
  var bestV64 = null, bestV64WR = 0, bestV64AR = 0
  for (var s = 0; s < strategyNames.length; s++) {
    var sName = strategyNames[s]
    if (sName === 'v72_v71base') continue
    var stats = calcDynamicStats(dynamicPicks[sName])
