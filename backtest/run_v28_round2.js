...
// Round 2: refine V28b (winner) and V28c (highest 5dWR improvement)
// V28b = 0.4/0.6 with base bands; V28c = 0.5/0.5 with chg 3-5=35
// Try combining: 0.35/0.65, 0.3/0.7, 0.4/0.6+chg35, 0.35/0.65+chg35+adx, etc.
var VARIANTS = {
  "V28b_base_0.4_0.6": {
  ...
  "V28b6_0.4_chg35_vr40": {
    v10Weight: 0.4, mildWeight: 0.6,
    chgBands: [[1,3,40],[0.5,1,25],[3,5,35],[5,7,15],[7,99,5]],
    chgDefault: 10,
    vrBands: [[1,2.5,40],[0.7,1,25],[2.5,3.5,30],[3.5,5,15],[5,99,5]],
    vrDefault: 10,
    rsiBands: [[40,60,20],[30,40,15],[60,70,10],[70,99,3]],
    rsiDefault: 8,
  },
  "V28b7_0.4_chg35_rsi25": {
    v10Weight: 0.4, mildWeight: 0.6,
    chgBands: [[1,3,40],[0.5,1,25],[3,5,35],[5,7,15],[7,99,5]],
    chgDefault: 10,
    vrBands: [[1,2,40],[0.7,1,25],[2,3,30],[3,5,15],[5,99,5]],
    vrDefault: 10,
    rsiBands: [[40,60,25],[30,40,18],[60,70,12],[70,99,3]],
    rsiDefault: 8,
  },
  "V28b8_0.45_chg35": {
    v10Weight: 0.45, mildWeight: 0.55,
    chgBands: [[1,3,40],[0.5,1,25],[3,5,35],[5,7,15],[7,99,5]],
    chgDefault: 10,
    vrBands: [[1,2,40],[0.7,1,25],[2,3,30],[3,5,15],[5,99,5]],
    vrDefault: 10,
  ...
  "V28b9_0.4_chg35_vr35": {
    v10Weight: 0.4, mildWeight: 0.6,
    chgBands: [[1,3,40],[0.5,1,25],[3,5,35],[5,7,15],[7,99,5]],
    chgDefault: 10,
    vrBands: [[1,2,35],[0.7,1,22],[2,3,28],[3,5,15],[5,99,5]],
    vrDefault: 10,
    rsiBands: [[40,60,20],[30,40,15],[60,70,10],[70,99,3]],
    rsiDefault: 8,
  },
  "V28b10_0.4_chg40": {
    v10Weight: 0.4, mildWeight: 0.6,
    chgBands: [[1,3,45],[0.5,1,25],[3,5,40],[5,7,15],[7,99,5]],
    chgDefault: 10,
    vrBands: [[1,2,40],[0.7,1,25],[2,3,30],[3,5,15],[5,99,5]],
    vrDefault: 10,
    rsiBands: [[40,60,20],[30,40,15],[60,70,10],[70,99,3]],
...
async function runBacktest() {
  ...
  console.log("V28 Round 2 Refinement Sweep")
  console.log("=".repeat(60))
  ...
  lines.push("V28 Round 2 Refinement Sweep - Backtest Report")
  lines.push("=".repeat(80))
  lines.push("")
  ...
  lines.push("")
  lines.push("Variant".padEnd(22) + "5dWR".padEnd(10) + "5dAR".padEnd(10) + "10dWR".padEnd(10) + "10dAR".padEnd(10) + "BeatsV10")
  ...
  fs.writeFileSync(path.join(CONFIG.outputDir, "backtest_v28_round2.txt"), report, "utf8")
  console.log("\n" + report)
}
