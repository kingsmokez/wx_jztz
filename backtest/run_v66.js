...
// ===== V66策略定义 =====
// V65最佳: v65_pb_bs_ma10 (WR=76.42% AR=1.09% n=687)
// V66目标: 在保持WR>=75%的前提下，提高AR到1.5%+
var V64_STRATEGIES = {
  "v66_base_ma10": {
  ...
  "v66_ma10_sc65": {
    stopLoss: -100, trailingRules: [
      { profitPct: 3, trailingPct: 1 }, { profitPct: 5, trailingPct: 2 }, { profitPct: 8, trailingPct: 3 }
    ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0.02, requirePattern: 'any', minScore: 65, patternWeight: 2.0,
    allowedPatterns: ['platform_break', 'boll_squeeze']
  },
  "v66_ma10_003": {
    stopLoss: -100, trailingRules: [
      { profitPct: 3, trailingPct: 1 }, { profitPct: 5, trailingPct: 2 }, { profitPct: 8, trailingPct: 3 }
    ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0.03, requirePattern: 'any', minScore: 60, patternWeight: 2.0,
    allowedPatterns: ['platform_break', 'boll_squeeze']
  },
  "v66_ma10_4710": {
    stopLoss: -100, trailingRules: [
  ...
  "v66_ma10_247": {
    stopLoss: -100, trailingRules: [
      { profitPct: 2, trailingPct: 0.5 }, { profitPct: 4, trailingPct: 1.5 }, { profitPct: 7, trailingPct: 2.5 }
    ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0.02, requirePattern: 'any', minScore: 60, patternWeight: 2.0,
    allowedPatterns: ['platform_break', 'boll_squeeze']
  },
  "v66_ma10_rsi75": {
    ...
    rsiMax: 75, allowedPatterns: ['platform_break', 'boll_squeeze']
  },
  "v66_ma10_adx20": {
    stopLoss: -100, trailingRules: [
      { profitPct: 3, trailingPct: 1 }, { profitPct: 5, trailingPct: 2 }, { profitPct: 8, trailingPct: 3 }
    ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0.02, requirePattern: 'any', minScore: 60, patternWeight: 2.0,
    adxMin: 20, allowedPatterns: ['platform_break', 'boll_squeeze']
  },
  "v66_ma10_21d": {
    stopLoss: -100, trailingRules: [
      { profitPct: 3, trailingPct: 1 }, { profitPct: 5, trailingPct: 2 }, { profitPct: 8, trailingPct: 3 }, { profitPct: 12, trailingPct: 4 }
    ], maxHoldDays: 21, ma5Min: 0.1, ma10Min: 0.02, requirePattern: 'any', minScore: 60, patternWeight: 2.0,
    allowedPatterns: ['platform_break', 'boll_squeeze']
  },
  "v66_ma10_sl5": {
    stopLoss: -5, trailingRules: [
      { profitPct: 3, trailingPct: 1 }, { profitPct: 5, trailingPct: 2 }, { profitPct: 8, trailingPct: 3 }
    ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0.02, requirePattern: 'any', minScore: 60, patternWeight: 2.0,
    allowedPatterns: ['platform_break', 'boll_squeeze']
  },
  "v66_ma10_sl7": {
    stopLoss: -7, trailingRules: [
      { profitPct: 3, trailingPct: 1 }, { profitPct: 5, trailingPct: 2 }, { profitPct: 8, trailingPct: 3 }
    ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0.02, requirePattern: 'any', minScore: 60, patternWeight: 2.0,
    allowedPatterns: ['platform_break', 'boll_squeeze']
  },
  "v66_ma10_vr18": {
    ...
    vrMin: 1.8, allowedPatterns: ['platform_break', 'boll_squeeze']
  },
  "v66_ma10_turnover": {
    stopLoss: -100, trailingRules: [
      { profitPct: 3, trailingPct: 1 }, { profitPct: 5, trailingPct: 2 }, { profitPct: 8, trailingPct: 3 }
    ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0.02, requirePattern: 'any', minScore: 60, patternWeight: 2.0,
    turnoverMin: 3, turnoverMax: 15, allowedPatterns: ['platform_break', 'boll_squeeze']
  },
  "v66_ma10_chg5": {
    stopLoss: -100, trailingRules: [
      { profitPct: 3, trailingPct: 1 }, { profitPct: 5, trailingPct: 2 }, { profitPct: 8, trailingPct: 3 }
    ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0.02, requirePattern: 'any', minScore: 60, patternWeight: 2.0,
    chgMax: 5, allowedPatterns: ['platform_break', 'boll_squeeze']
  },
  "v66_ma10_369": {
    stopLoss: -100, trailingRules: [
      { profitPct: 3, trailingPct: 1.5 }, { profitPct: 6, trailingPct: 2 }, { profitPct: 9, trailingPct: 3 }
    ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0.02, requirePattern: 'any', minScore: 60, patternWeight: 2.0,
    allowedPatterns: ['platform_break', 'boll_squeeze']
  },
  "v66_bs_only_ma10": {
    stopLoss: -100, trailingRules: [
      { profitPct: 3, trailingPct: 1 }, { profitPct: 5, trailingPct: 2 }, { profitPct: 8, trailingPct: 3 }
    ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0.02, requirePattern: 'boll_squeeze', minScore: 60, patternWeight: 2.0
  },
  "v66_pb_only_ma10": {
    stopLoss: -100, trailingRules: [
      { profitPct: 3, trailingPct: 1 }, { profitPct: 5, trailingPct: 2 }, { profitPct: 8, trailingPct: 3 }
    ], maxHoldDays: 18, ma5Min: 0.1, ma10Min: 0.02, requirePattern: 'platform_break', minScore: 60, patternWeight: 2.0
  },
  "v66_ma10_sc65_adx20": {
    stopLoss: -100, trailingRules: [
      { profitPct: 3, trailingPct: 1 }, { profitPct: 5, trailingPct: 2 }, { profitPct: 8, trailingPct: 3 }
...
async function runBacktest() {
  ...
  console.log('V66 Strategy Backtest: MA10趋势确认+提高AR')
  console.log('='.repeat(80))
  ...
  var output = []
  output.push('================================================================================')
  output.push('V66 Strategy Backtest: MA10趋势确认+提高AR')
  output.push('================================================================================')
  output.push('')
  ...
  // V64base基线
  var v63BaseStats = calcDynamicStats(dynamicPicks['v66_base_ma10'] || [])
  ...
  var anyPicks = dynamicPicks['v66_base_ma10'] || []
  var patternStats = {}
  ...
  for (var s = 0; s < strategyNames.length; s++) {
    var sName = strategyNames[s]
    if (sName === 'v66_base_ma10') continue
    var stats = calcDynamicStats(dynamicPicks[sName])
  ...
  fs.writeFileSync(path.join(CONFIG.outputDir, 'backtest_v66.txt'), output.join('\n'), 'utf8')
  console.log('\nResults saved to backtest/results/backtest_v66.txt')
}
