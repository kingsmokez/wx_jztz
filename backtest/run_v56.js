...
function simulatePickV43b(dayQuotes, klineMap, dateIdxMap, topN, marketEnv, ma5Min, ma10Min, rsiMax, adxMin, v31W, v10W, minScoreOverride) {
...
async function runBacktest() {
  ...
  for (var si = 0; si < sampleDates.length; si++) {
    ...
    for (var s = 0; s < strategyNames.length; s++) {
      ...
      var sPicks = simulatePickV43b(dayQuotes, klineMap, dateIdxMap, CONFIG.topN, marketEnv, strategy.ma5Min, strategy.ma10Min, strategy.rsiMax, strategy.adxMin, strategy.v31W, strategy.v10W, strategy.minScore)
  ...
  var output = []
  output.push('================================================================================')
  output.push('V56 Strategy Backtest: minScore阈值+形态过滤探索')
  output.push('================================================================================')
  output.push('')
  ...
  fs.writeFileSync(path.join(CONFIG.outputDir, 'backtest_v56.txt'), output.join('\n'), 'utf8')
