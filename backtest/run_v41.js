// run_v41.js - V41策略回测: V40d(p95+rs+vr)参数深挖: 基于p95价格位置硬过滤深挖最优参数
var fs = require('fs')
...
var VARIANTS = {
  // V40d基准 (10dWR=58.33%, 10dAR=2.35%, n=156)
  "V40d_ref": { v31Weight: 0.75, v10Weight: 0.25, adaptiveMarket: true, morphBonus: true, softVolConfirm: true, volPenalty: 0.9, dynamicConsec: true, consecBear: 3, consecNeutral: 5, consecBull: 6, pricePosFilter: true, pricePosThreshold: 0.95, rsFilter: true, rsThreshold: 0, volumeRatioFilter: true, volumeRatioMin: 1.5, _minScore: 60 },
  // V40f基准 (10dAR=2.42%, n=235)
  "V40f_ref": { v31Weight: 0.75, v10Weight: 0.25, adaptiveMarket: true, morphBonus: true, softVolConfirm: true, volPenalty: 0.9, dynamicConsec: true, consecBear: 3, consecNeutral: 5, consecBull: 6, pricePosFilter: true, pricePosThreshold: 0.95, rsFilter: true, rsThreshold: 5, _minScore: 60 },
  // 量比阈值微调
  "V41a_vr12": { v31Weight: 0.75, v10Weight: 0.25, adaptiveMarket: true, morphBonus: true, softVolConfirm: true, volPenalty: 0.9, dynamicConsec: true, consecBear: 3, consecNeutral: 5, consecBull: 6, pricePosFilter: true, pricePosThreshold: 0.95, rsFilter: true, rsThreshold: 0, volumeRatioFilter: true, volumeRatioMin: 1.2, _minScore: 60 },
  "V41b_vr10": { v31Weight: 0.75, v10Weight: 0.25, adaptiveMarket: true, morphBonus: true, softVolConfirm: true, volPenalty: 0.9, dynamicConsec: true, consecBear: 3, consecNeutral: 5, consecBull: 6, pricePosFilter: true, pricePosThreshold: 0.95, rsFilter: true, rsThreshold: 0, volumeRatioFilter: true, volumeRatioMin: 1.0, _minScore: 60 },
  "V41c_vr18": { v31Weight: 0.75, v10Weight: 0.25, adaptiveMarket: true, morphBonus: true, softVolConfirm: true, volPenalty: 0.9, dynamicConsec: true, consecBear: 3, consecNeutral: 5, consecBull: 6, pricePosFilter: true, pricePosThreshold: 0.95, rsFilter: true, rsThreshold: 0, volumeRatioFilter: true, volumeRatioMin: 1.8, _minScore: 60 },
  // p96+rs+vr组合
  "V41d_p96_vr": { v31Weight: 0.75, v10Weight: 0.25, adaptiveMarket: true, morphBonus: true, softVolConfirm: true, volPenalty: 0.9, dynamicConsec: true, consecBear: 3, consecNeutral: 5, consecBull: 6, pricePosFilter: true, pricePosThreshold: 0.96, rsFilter: true, rsThreshold: 0, volumeRatioFilter: true, volumeRatioMin: 1.5, _minScore: 60 },
  // rs5+vr组合
  "V41e_rs5_vr": { v31Weight: 0.75, v10Weight: 0.25, adaptiveMarket: true, morphBonus: true, softVolConfirm: true, volPenalty: 0.9, dynamicConsec: true, consecBear: 3, consecNeutral: 5, consecBull: 6, pricePosFilter: true, pricePosThreshold: 0.95, rsFilter: true, rsThreshold: 5, volumeRatioFilter: true, volumeRatioMin: 1.5, _minScore: 60 },
  "V41f_rs3_vr": { v31Weight: 0.75, v10Weight: 0.25, adaptiveMarket: true, morphBonus: true, softVolConfirm: true, volPenalty: 0.9, dynamicConsec: true, consecBear: 3, consecNeutral: 5, consecBull: 6, pricePosFilter: true, pricePosThreshold: 0.95, rsFilter: true, rsThreshold: 3, volumeRatioFilter: true, volumeRatioMin: 1.5, _minScore: 60 },
  // rs5+vr+p96
  "V41g_p96_rs5_vr": { v31Weight: 0.75, v10Weight: 0.25, adaptiveMarket: true, morphBonus: true, softVolConfirm: true, volPenalty: 0.9, dynamicConsec: true, consecBear: 3, consecNeutral: 5, consecBull: 6, pricePosFilter: true, pricePosThreshold: 0.96, rsFilter: true, rsThreshold: 5, volumeRatioFilter: true, volumeRatioMin: 1.5, _minScore: 60 },
  // minScore微调
  "V41h_vr_m55": { v31Weight: 0.75, v10Weight: 0.25, adaptiveMarket: true, morphBonus: true, softVolConfirm: true, volPenalty: 0.9, dynamicConsec: true, consecBear: 3, consecNeutral: 5, consecBull: 6, pricePosFilter: true, pricePosThreshold: 0.95, rsFilter: true, rsThreshold: 0, volumeRatioFilter: true, volumeRatioMin: 1.5, _minScore: 55 },
  "V41i_vr_m65": { v31Weight: 0.75, v10Weight: 0.25, adaptiveMarket: true, morphBonus: true, softVolConfirm: true, volPenalty: 0.9, dynamicConsec: true, consecBear: 3, consecNeutral: 5, consecBull: 6, pricePosFilter: true, pricePosThreshold: 0.95, rsFilter: true, rsThreshold: 0, volumeRatioFilter: true, volumeRatioMin: 1.5, _minScore: 65 },
  // 评分权重微调
  "V41j_vr_v31_80": { v31Weight: 0.80, v10Weight: 0.20, adaptiveMarket: true, morphBonus: true, softVolConfirm: true, volPenalty: 0.9, dynamicConsec: true, consecBear: 3, consecNeutral: 5, consecBull: 6, pricePosFilter: true, pricePosThreshold: 0.95, rsFilter: true, rsThreshold: 0, volumeRatioFilter: true, volumeRatioMin: 1.5, _minScore: 60 },
  "V41k_vr_v31_70": { v31Weight: 0.70, v10Weight: 0.30, adaptiveMarket: true, morphBonus: true, softVolConfirm: true, volPenalty: 0.9, dynamicConsec: true, consecBear: 3, consecNeutral: 5, consecBull: 6, pricePosFilter: true, pricePosThreshold: 0.95, rsFilter: true, rsThreshold: 0, volumeRatioFilter: true, volumeRatioMin: 1.5, _minScore: 60 },
  // vr去掉softVolConfirm (因为已经有vr硬过滤了)
  "V41l_vr_nosoft": { v31Weight: 0.75, v10Weight: 0.25, adaptiveMarket: true, morphBonus: true, softVolConfirm: false, dynamicConsec: true, consecBear: 3, consecNeutral: 5, consecBull: 6, pricePosFilter: true, pricePosThreshold: 0.95, rsFilter: true, rsThreshold: 0, volumeRatioFilter: true, volumeRatioMin: 1.5, _minScore: 60 },
}

async function runBacktest() {
  console.log('='.repeat(60))
  console.log('V41 Strategy: V40d(p95+rs+vr) + V40f(rs5) Deep Optimization')
  console.log('='.repeat(60))
  ...
  console.log('\n' + '='.repeat(80))
  console.log('V41 Strategy Backtest - V40d(p95+rs+vr) + V40f(rs5) Deep Optimization')
  ...
  var output = []
  output.push('================================================================================')
  output.push('V41 Strategy Backtest - V40d(p95+rs+vr) + V40f(rs5) Deep Optimization')
  output.push('================================================================================')
  output.push('')
  ...
  fs.writeFileSync(path.join(CONFIG.outputDir, 'backtest_v41.txt'), output.join('\n'), 'utf8')
  console.log('\nResults saved to backtest/results/backtest_v41.txt')
}
