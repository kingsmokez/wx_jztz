...
async function runBacktest() {
  ...
  console.log('V74 Strategy Backtest: 多形态融合+放宽参数+扩大选股')
  console.log('='.repeat(80))
  ...
  // 运行各策略
  var strategyNames = Object.keys(V74_STRATEGIES)
  var dynamicPicks = {}
  var patternCounts = {}
  ...
  for (var si = 0; si < sampleDates.length; si++) {
    ...
    for (var s = 0; s < strategyNames.length; s++) {
      ...
      var strategy = V74_STRATEGIES[sName]
  ...
  var output = []
  output.push('================================================================================')
  output.push('V74 Strategy Backtest: 多形态融合+放宽参数+扩大@选股')
  output.push('================================================================================')
  output.push('')
  ...
  fs.writeFileSync(path.join(CONFIG.outputDir, 'backtest_v74.txt'), output.join('\n'), 'utf8')
  console.log('\nResults saved to backtest/results/backtest_v74.txt')
}
