...
// Round 3: Fine-tune around V28b4 (0.35/0.65 + chg35)
// V28b4 was best: 46.19/0.37/48.72/0.94
// Try: 0.33/0.67, 0.37/0.63, chg bands tweaks, combined with adx/ma bonuses
var VARIANTS = {
  "V28b4_0.35_chg35": {
  ...
  "V29a_0.33_chg35": {
    v10Weight: 0.33, mildWeight: 0.67,
    chgBands: [[1,3,40],[0.5,1,25],[3,5,35],[5,7,15],[7,99,5]],
    chgDefault: 10,
    vrBands: [[1,2,40],[0.7,1,25],[2,3,30],[3,5,15],[5,99,5]],
    vrDefault: 10,
  ...
  "V29b_0.37_chg35": {
    v10Weight: 0.37, mildWeight: 0.63,
    chgBands: [[1,3,40],[0.5,1,25],[3,5,35],[5,7,15],[7,99,5]],
    chgDefault: 10,
    vrBands: [[1,2,40],[0.7,1,25],[2,3,30],[3,5,15],[5,99,5]],
    vrDefault: 10,
  ...
  "V29c_0.35_chg38": {
    v10Weight: 0.35, mildWeight: 0.65,
    chgBands: [[1,3,40],[0.5,1,25],[3,5,38],[5,7,15],[7,99,5]],
    chgDefault: 10,
    vrBands: [[1,2,40],[0.7,1,25],[2,3,30],[3,5,15],[5,99,5]],
    vrDefault: 10,
    rsiBands: [[40,60,20],[30,40,15],[60,70,10],[70,99,3]],
  ...
  "V29d_0.35_chg35_vr1_2.5": {
    v10Weight: 0.35, mildWeight: 0.65,
    chgBands: [[1,3,40],[0.5,1,25],[3,5,35],[5,7,15],[7,99,5]],
    chgDefault: 10,
    vrBands: [[1,2.5,40],[0.7,1,25],[2.5,3.5,28],[3.5,5,15],[5,99,5]],
    vrDefault: 10,
    rsiBands: [[40,60,20],[30,40,15],[60,70,10],[70,99,3]],
    rsiDefault: 8,
  },
  "V29e_0.35_chg35_adx6": {
    v10Weight: 0.35, mildWeight: 0.65,
    chgBands: [[1,3,40],[0.5,1,25],[3,5,35],[5,7,15],[7,99,5]],
    chgDefault: 10,
    vrBands: [[1,2,40],[0.7,1,25],[2,3,30],[3,5,15],[5,99,5]],
  ...
  "V29g_0.35_chg1_2.5": {
    v10Weight: 0.35, mildWeight: 0.65,
    chgBands: [[1,2.5,42],[0.5,1,28],[2.5,5,35],[5,7,15],[7,99,5]],
    chgDefault: 10,
    vrBands: [[1,2,40],[0.7,1,25],[2,3,30],[3,5,15],[5,99,5]],
    vrDefault: 10,
    rsiBands: [[40,60,20],[30,40,15],[60,70,10],[70,99,3]],
...
async function runBacktest() {
  ...
  console.log("V29 Round 3 Fine-tuning Sweep")
  console.log("=".repeat(60))
  ...
  for (var si = 0; si < sampleDates.length; si++) {
    ...
    for (var v = 0; v < variantNames.length; v++) {
      ...
      var topN = params._topN || CONFIG.topN
      var origMinScore = CONFIG.minScore
      if (params._minScore) CONFIG.minScore = params._minScore
      var picks = simulatePickV28Variant(dayQuotes, klineMap, dateIdxMap, topN, params)
      CONFIG.minScore = origMinScore
  ...
  lines.push("V29 Round 3 Fine-tuning - Backtest Report")
  lines.push("=".repeat(80))
  lines.push("")
  ...
  lines.push("")
  lines.push("Variant".padEnd(24) + "5dWR".padEnd(10) + "5dAR".padEnd(10) + "10dWR".padEnd(10) + "10dAR".padEnd(10) + "N".padEnd(6) + "Beats")
  ...
  for (var r = 0; r < resultsTable.length; r++) {
    ...
    lines.push(row.name.padEnd(24) + (row.wr5 || "-").toString().padEnd(10) + (row.ar5 || "-").toString().padEnd(10) + (row.wr10 || "-").toString().padEnd(10) + (row.ar10 || "-").toString().padEnd(10) + row.n.toString().padEnd(6) + allBeat)
  }
  ...
  fs.writeFileSync(path.join(CONFIG.outputDir, "backtest_v29_round3.txt"), report, "utf8")
  console.log("\n" + report)
}
