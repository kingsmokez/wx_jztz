...
var V71_STRATEGIES = {
  ...
  "v71_multi3": {
    stopLoss: -100, trailingRules: [
      { profitPct: 3, trailingPct: 1 }, { profitPct: 5, trailingPct: 2 }, { profitPct: 8, trailingPct: 3 }
    ], maxHoldDays: 21, ma5Min: 0.1, ma10Min: 0.02, requirePattern: 'any', minScore: 65, patternWeight: 2.0,
    chgMin: 1, chgMax: 2.5, vrMin: 1.8, adxMin: 20, allowedPatterns: ['boll_squeeze', 'platform_break', 'pullback_restart']
  },
  "v71_multi3_narrow": {
    stopLoss: -100, trailingRules: [
      { profitPct: 3, trailingPct: 1 }, { profitPct: 5, trailingPct: 2 }, { profitPct: 8, trailingPct: 3 }
    ], maxHoldDays: 21, ma5Min: 0.1, ma10Min: 0.02, requirePattern: 'any', minScore: 65, patternWeight: 2.0,
    chgMin: 1, chgMax: 2, vrMin: 1.8, adxMin: 20, allowedPatterns: ['boll_squeeze', 'platform_break', 'pullback_restart']
  },
  "v71_multi3_rsi65": {
    stopLoss: -100, trailingRules: [
      { profitPct: 3, trailingPct: 1 }, { profitPct: 5, trailingPct: 2 }, { profitPct: 8, trailingPct: 3 }
    ], maxHoldDays: 21, ma5Min: 0.1, ma10Min: 0.02, requirePattern: 'any', minScore: 65, patternWeight: 2.0,
    chgMin: 1, chgMax: 2.5, vrMin: 1.8, adxMin: 20, rsiMax: 65, allowedPatterns: ['boll_squeeze', 'platform_break', 'pullback_restart']
  },
  "v71_multi3_sc70": {
    stopLoss: -100, trailingRules: [
      { profitPct: 3, trailingPct: 1 }, { profitPct: 5, trailingPct: 2 }, { profitPct: 8, trailingPct: 3 }
    ], maxHoldDays: 21, ma5Min: 0.1, ma10Min: 0.02, requirePattern: 'any', minScore: 70, patternWeight: 2.0,
    chgMin: 1, chgMax: 2.5, vrMin: 1.8, adxMin: 20, allowedPatterns: ['boll_squeeze', 'platform_break', 'pullback_restart']
  },
  "v71_multi3_4710": {
    stopLoss: -100, trailingRules: [
  ...
  "v71_multi3_vr20": {
    ...
    chgMin: 1, chgMax: 2.5, vrMin: 2.0, adxMin: 20, allowedPatterns: ['boll_squeeze', 'platform_break', 'pullback_restart']
  },
  "v71_multi3_adx25": {
    stopLoss: -100, trailingRules: [
      { profitPct: 3, trailingPct: 1 }, { profitPct: 5, trailingPct: 2 }, { profitPct: 8, trailingPct: 3 }
    ], maxHoldDays: 21, ma5Min: 0.1, ma10Min: 0.02, requirePattern: 'any', minScore: 65, patternWeight: 2.0,
    chgMin: 1, chgMax: 2.5, vrMin: 1.8, adxMin: 25, allowedPatterns: ['boll_squeeze', 'platform_break', 'pullback_restart']
  },
  "v71_bs_rsi65": {
    stopLoss: -100, trailingRules: [
      { profitPct: 3, trailingPct: 1 }, { profitPct: 5, trailingPct: 2 }, { profitPct: 8, trailingPct: 3 }
    ], maxHoldDays: 21, ma5Min: 0.1, ma10Min: 0.02, requirePattern: 'boll_squeeze', minScore: 65, patternWeight: 2.0,
    chgMin: 1, chgMax: 2.5, vrMin: 1.8, adxMin: 20, rsiMax: 65
  },
  "v71_bs_sc70": {
    stopLoss: -100, trailingRules: [
      { profitPct: 3, trailingPct: 1 }, { profitPct: 5, trailingPct: 2 }, { profitPct: 8, trailingPct: 3 }
  ...
  "v71_multi3_25d": {
    ...
    ], maxHoldDays: 25, ma5Min: 0.1, ma10Min: 0.02, requirePattern: 'any', minScore: 65, patternWeight: 2.0,
    chgMin: 1, chgMax: 2.5, vrMin: 1.8, adxMin: 20, allowedPatterns: ['boll_squeeze', 'platform_break', 'pullback_restart']
  },
}
...
async function runBacktest() {
  ...
  console.log('V71 Strategy Backtest: 多形态组合+OBV确认+参数优化')
  console.log('='.repeat(80))
  ...
  // 运行各策略
  var strategyNames = Object.keys(V71_STRATEGIES)
  var dynamicPicks = {}
  var patternCounts = {}
  ...
  for (var si = 0; si < sampleDates.length; si++) {
    ...
    for (var s = 0; s < strategyNames.length; s++) {
      ...
      var strategy = V71_STRATEGIES[sName]
  ...
  var output = []
  output.push('================================================================================')
  output.push('V71 Strategy Backtest: 多形态组合+OBV确认+参数优化')
  output.push('================================================================================')
  output.push('')
  ...
  summaryLines.push('')
  summaryLines.push('Strategy'.padEnd(24) + '  n   WR%   AR%  AvgD  vsV70baseWR  vsV70baseAR  PatternBreakdown')
  summaryLines.push('-'.repeat(110))

  // V70base基线
  var v70BaseStats = calcDynamicStats(dynamicPicks['v71_v70base'] || [])
  var v70BaseWR = v70BaseStats.winRate
  var v70BaseAR = v70BaseStats.avgReturn
  ...
  for (var s = 0; s < strategyNames.length; s++) {
    ...
    var wrDiff = (stats.winRate - v70BaseWR).toFixed(2)
    var arDiff = (stats.avgReturn - v70BaseAR).toFixed(2)
    ...
    if (stats.winRate > v70BaseWR && stats.avgReturn > v70BaseAR) {
      console.log('>>> ' + sName + ': WR=' + stats.winRate + '% AR=' + stats.avgReturn + '% avgDay=' + stats.avgExitDay + ' BEATS V70base!')
    }
  }
  ...
  var anyPicks = dynamicPicks['v71_v70base'] || []
  var patternStats = {}
  ...
  output.push('| V70base | gapUp+3/5/8% | ' + v70BaseWR + ' | ' + v70BaseAR + ' | ' + v70BaseStats.total + ' | ' + v70BaseStats.avgExitDay + ' |')
  
  // 找最佳V64策略
  var bestV64 = null, bestV64WR = 0, bestV64AR = 0
  for (var s = 0; s < strategyNames.length; s++) {
    var sName = strategyNames[s]
    if (sName === 'v71_v70base') continue
    var stats = calcDynamicStats(dynamicPicks[sName])
