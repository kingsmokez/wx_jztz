...
var EXIT_STRATEGIES = {
  "V49c_obv_filter": { stopLoss: -100, trailingRules: [
    { profitPct: 5, trailingPct: 2 },
    { profitPct: 8, trailingPct: 3 },
    { profitPct: 12, trailingPct: 4 }
  ], maxHoldDays: 18 },
  "V49c_ma_slope": { stopLoss: -100, trailingRules: [
    { profitPct: 5, trailingPct: 2 },
    { profitPct: 8, trailingPct: 3 },
    { profitPct: 12, trailingPct: 4 }
  ], maxHoldDays: 18 },
  "V49c_both": { stopLoss: -100, trailingRules: [
    { profitPct: 5, trailingPct: 2 },
    { profitPct: 8, trailingPct: 3 },
    { profitPct: 12, trailingPct: 4 }
  ], maxHoldDays: 18 },
  "V49c_vol2": { stopLoss: -100, trailingRules: [
    { profitPct: 5, trailingPct: 2 },
    { profitPct: 8, trailingPct: 3 },
    { profitPct: 12, trailingPct: 4 }
  ], maxHoldDays: 18 }
...
async function runBacktest() {
  ...
  console.log('V49c Strategy Backtest: 新硬过滤条件测试')
  console.log('='.repeat(80))
  ...
  fs.writeFileSync(path.join(CONFIG.outputDir, 'backtest_v49c.txt'), output.join('\n'), 'utf8')
